...
@SourceDebugExtension(value={"SMAP\nIPlayerCriterionGrant.kt\nKotlin\n*S Kotlin\n*F\n+ 1 IPlayerCriterionGrant.kt\nink/ptms/chemdah/core/quest/objective/bukkit/paper/IPlayerCriterionGrant\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,34:1\n1747#2,3:35\n1747#2,3:38\n*S KotlinDebug\n*F\n+ 1 IPlayerCriterionGrant.kt\nink/ptms/chemdah/core/quest/objective/bukkit/paper/IPlayerCriterionGrant\n*L\n28#1:35,3\n31#1:38,3\n*E\n"})
...
extends ObjectiveCountableI<PlayerAdvancementCriterionGrantEvent> {
    ...
    @NotNull
    private static final Class<PlayerAdvancementCriterionGrantEvent> event = PlayerAdvancementCriterionGrantEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerAdvancementCriterionGrantEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerAdvancementCriterionGrantEvent e) {
        boolean bl;
        block3: {
            ...
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    ...
                    boolean bl2 = false;
                    if (!StringsKt.equals((String)it, (String)e.getAdvancement().getKey().toString(), (boolean)true)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    private static final Boolean _init_$lambda$5(Data data2, PlayerAdvancementCriterionGrantEvent e) {
        boolean bl;
        block3: {
            Iterable $this$any$iv = data2.asList();
            boolean $i$f$any = false;
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    String it = (String)element$iv;
                    boolean bl2 = false;
                    if (!StringsKt.equals((String)it, (String)e.getCriterion(), (boolean)true)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerCriterionGrant::_init_$lambda$1);
        INSTANCE.addSimpleCondition("advancement", IPlayerCriterionGrant::_init_$lambda$3);
        INSTANCE.addSimpleCondition("criterion", IPlayerCriterionGrant::_init_$lambda$5);
    }
}
