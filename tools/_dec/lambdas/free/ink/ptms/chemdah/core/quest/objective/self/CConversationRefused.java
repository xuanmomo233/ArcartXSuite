...
@MetaInfo(source="chemdah", name="\u5bf9\u8bdd\u653e\u5f03\u76ee\u6807", description={"\u73a9\u5bb6\u653e\u5f03\u6216\u62d2\u7edd\u5bf9\u8bdd", "\u652f\u6301\u4f4d\u7f6e\u3001\u5bf9\u8bddID\u7b49\u6761\u4ef6\u5224\u65ad", "\u9002\u7528\u4e8e Chemdah \u5185\u90e8\u5bf9\u8bdd\u7cfb\u7edf"}, alias={"\u5bf9\u8bdd\u653e\u5f03", "\u62d2\u7edd\u5bf9\u8bdd", "conversation\u62d2\u7edd"}, params={@ParamInfo(name="position", type="location", description="\u68c0\u6d4b\u5bf9\u8bdd\u653e\u5f03\u4f4d\u7f6e"), @ParamInfo(name="id", type="string", description="\u5bf9\u8bddID\uff0c\u7528\u4e8e\u8fc7\u6ee4\u7279\u5b9a\u5bf9\u8bdd")})
...
extends ObjectiveCountableI<ConversationEvents.Closed> {
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, ConversationEvents.Closed it) {
        ...
        Intrinsics.checkNotNullParameter((Object)((Object)it), (String)"it");
        return it.getSession().getLocation();
    }
    ...
    static {
        ...
        INSTANCE.addCondition("position", "Location", CConversationRefused::_init_$lambda$1);
        INSTANCE.addCondition("id", "String", CConversationRefused::_init_$lambda$2);
        INSTANCE.addConditionVariable("id", CConversationRefused::_init_$lambda$3);
    }
}
