...
extends ObjectiveCountableI<EntityCombustByEntityEvent> {
    ...
    @NotNull
    private static final Class<EntityCombustByEntityEvent> event = EntityCombustByEntityEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, EntityCombustByEntityEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, EntityCombustByEntityEvent e) {
        return data2.toInferEntity().isEntity(e.getEntity());
    }

    static {
        INSTANCE.handler(IEntityCombust::_init_$lambda$0);
        INSTANCE.addSimpleCondition("position", IEntityCombust::_init_$lambda$1);
        INSTANCE.addSimpleCondition("entity", IEntityCombust::_init_$lambda$2);
    }
}
