...
extends ObjectiveCountableI<PlayerMoveEvent> {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerRealMove::_init_$lambda$1);
        INSTANCE.addSimpleCondition("position:to", IPlayerRealMove::_init_$lambda$2);
        INSTANCE.addSimpleCondition("position:from", IPlayerRealMove::_init_$lambda$3);
    }
}
