...
public class Conversation {
    ...
    public Conversation(@NotNull String id2, @Nullable File file, @NotNull ConfigurationSection root2, @NotNull Option option) {
        ...
        if (object != null && (object = CollectionKt.asList((Object)object)) != null) {
            ...
            for (Object item$iv$iv : $this$mapTo$iv$iv) {
                ...
                boolean bl2 = false;
                collection.add(new Trigger.Id((String)it4.get(0), (String)it4.get(1), CollectionsKt.drop((Iterable)((Iterable)it4), (int)2)));
            }
    ...
    public boolean isNPC(@NotNull String namespace, @NotNull String id2, @NotNull Player player2) {
        boolean bl;
        block3: {
            ...
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    ...
                    boolean bl2 = false;
                    if (!it.isNPC(namespace, id2, player2)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
        ...
        block3: {
            ...
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    Trigger.Id it = (Trigger.Id)element$iv;
                    boolean bl2 = false;
                    if (!Trigger.Id.isNPC$default(it, namespace, id2, null, 4, null)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    @NotNull
    public <T> Session newSession(@NotNull Player player2, @NotNull Source<T> source) {
        Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
        ...
        return new Session(this, location, source.getOriginLocation(source.getEntity()), player2, source);
    }

    @NotNull
    public CompletableFuture<Session> openSelf(@NotNull Player player2, @NotNull String name) {
        Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
        Intrinsics.checkNotNullParameter((Object)name, (String)"name");
        return Conversation.open$default(this, player2, Source.Companion.of(name, player2), null, null, 12, null);
    }

    @NotNull
    public CompletableFuture<Session> open(@NotNull Player player2, @NotNull Source<?> source, @Nullable Session parent, @NotNull Consumer<Session> prepare) {
        Session session;
        Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
        Intrinsics.checkNotNullParameter(source, (String)"source");
        Intrinsics.checkNotNullParameter(prepare, (String)"prepare");
        DebugHandlerKt.debug((Entity)player2, Debug.CONVERSATION, "\u5c1d\u8bd5\u6253\u5f00\u5bf9\u8bdd: " + this.id + ", \u7ee7\u627f\u4f1a\u8bdd: " + (parent != null));
        CompletableFuture<Session> future = new CompletableFuture<Session>();
        Session session2 = parent;
        if (session2 == null) {
            session2 = this.newSession(player2, source);
        }
        if (UtilsKt.callIfFailed(new ConversationEvents.Pre(this, session = session2, parent != null))) {
            DebugHandlerKt.debug((Entity)player2, Debug.CONVERSATION, "\u5bf9\u8bdd\u88ab Pre \u4e8b\u4ef6\u53d6\u6d88");
            future.complete(session);
            new ConversationEvents.Cancelled(this, session, true).call();
            return future;
        }
        Entity entity = (Entity)player2;
        StringBuilder stringBuilder = new StringBuilder().append("\u68c0\u67e5\u5bf9\u8bdd\u6761\u4ef6: ");
        String string = this.condition;
        if (string == null) {
            string = "\u65e0\u6761\u4ef6";
        }
        DebugHandlerKt.debug(entity, Debug.CONVERSATION, stringBuilder.append(string).toString());
        FuturesKt.thenBool(this.checkCondition(session), (Function1<? super ProcessBool, Unit>)((Function1)new Function1<ProcessBool, Unit>(player2, this, source, session, prepare, parent, future){
            ...
            public final void invoke(@NotNull ProcessBool $this$thenBool) {
                ...
                $this$thenBool.ifTrue((Function0<Unit>)((Function0)new Function0<Unit>(this.$player, this.this$0, this.$source, this.$session, this.$prepare, this.$parent, this.$future){
                    final /* synthetic */ Player $player;
                    final /* synthetic */ Conversation this$0;
                    final /* synthetic */ Source<?> $source;
                    final /* synthetic */ Session $session;
                    ...
                    public final void invoke() {
                        Object[] objectArray;
                        DebugHandlerKt.debug((Entity)this.$player, Debug.CONVERSATION, "\u6761\u4ef6\u6ee1\u8db3");
                        ...
                        DebugHandlerKt.debug((Entity)this.$player, Debug.CONVERSATION, "\u4f1a\u8bdd\u5df2\u6ce8\u518c\uff0c\u5f53\u524d\u6d3b\u52a8\u4f1a\u8bdd\u6570: " + ConversationManager.INSTANCE.getSessions().size());
                        this.$prepare.accept(this.$session);
                        this.$session.setSource(this.$source);
                        this.$session.reload();
                        this.this$0.agent(this.$session, AgentType.BEGIN_ASYNC);
                        FuturesKt.acceptWithError(this.this$0.agent(this.$session, AgentType.BEGIN), (Function0<Unit>)((Function0)new Function0<Unit>(this.$session, this.$player, this.$parent, this.$future, this.this$0){
                            final /* synthetic */ Session $session;
                            final /* synthetic */ Player $player;
                            final /* synthetic */ Session $parent;
                            final /* synthetic */ CompletableFuture<Session> $future;
                            ...
                            public final void invoke() {
                                FuturesKt.acceptWithError(this.$session.resetTheme(), (Function0<Unit>)((Function0)new Function0<Unit>(this.$session, this.$player, this.$parent, this.$future, this.this$0){
                                    final /* synthetic */ Session $session;
                                    final /* synthetic */ Player $player;
                                    final /* synthetic */ Session $parent;
                                    final /* synthetic */ CompletableFuture<Session> $future;
                                    ...
                                    public final void invoke() {
                                        ...
                                        if (Coerce.toBoolean((Object)$this$cbool$iv)) {
                                            DebugHandlerKt.debug((Entity)this.$player, Debug.CONVERSATION, "\u5bf9\u8bdd\u88ab\u811a\u672c\u4ee3\u7406\u53d6\u6d88");
                                            if (this.$parent != null) {
                                            ...
                                            void $this$mapTo$iv$iv;
                                            void $this$map$iv;
                                            DebugHandlerKt.debug((Entity)this.$player, Debug.CONVERSATION, "\u5bf9\u8bdd\u5f00\u542f\u5b8c\u6210");
                                            ...
                                            FuturesKt.acceptWithError(this.this$0.getOption().getThemeInstance().onBegin(this.$session), (Function0<Unit>)((Function0)new Function0<Unit>(this.this$0, this.$session, this.$future, this.$parent){
                                                ...
                                                public final void invoke() {
                                                    ...
                                                    FuturesKt.acceptWithError(this.this$0.agent(this.$session, AgentType.START), (Function0<Unit>)((Function0)new Function0<Unit>(this.$future, this.$session, this.this$0, this.$parent){
                                                        ...
                                                        public final void invoke() {
                                                            this.$future.complete(this.$session);
                                                            this.this$0.getOption().getThemeInstance().onPostDisplay(this.$session);
                ...
                $this$thenBool.orElse((Function0<Unit>)((Function0)new Function0<Unit>(this.$player, this.$session, this.$future, this.this$0){
                    final /* synthetic */ Player $player;
                    final /* synthetic */ Session $session;
                    final /* synthetic */ CompletableFuture<Session> $future;
                    final /* synthetic */ Conversation this$0;
                    ...
                    public final void invoke() {
                        DebugHandlerKt.debug((Entity)this.$player, Debug.CONVERSATION, "\u6761\u4ef6\u4e0d\u6ee1\u8db3");
    ...
    public static /* synthetic */ CompletableFuture open$default(Conversation conversation2, Player player2, Source source, Session session, Consumer consumer, int n, Object object) {
        if (object != null) {
        ...
        if ((n & 8) != 0) {
            consumer = Conversation::open$lambda$7;
        }
        return conversation2.open(player2, source, session, consumer);
    }
    ...
    public CompletableFuture<Boolean> checkCondition(@NotNull Session session) {
        ...
        try {
            ...
            }), (int)58, null).thenApply(arg_0 -> Conversation.checkCondition$lambda$9$lambda$8(session, future, arg_0));
            return completableFuture;
        }
        catch (Throwable e) {
            DebugHandlerKt.debug((Entity)session.getPlayer(), Debug.CONVERSATION, "\u6761\u4ef6\u811a\u672c\u6267\u884c\u5931\u8d25: " + e.getMessage());
    ...
    public CompletableFuture<Void> agent(@NotNull Session session, @NotNull AgentType type) {
        ...
        if (UtilsKt.callIfFailed(new ConversationEvents.Agent(this, session, type))) {
            DebugHandlerKt.debug((Entity)session.getPlayer(), Debug.CONVERSATION, "Agent " + type.name() + " \u88ab\u4e8b\u4ef6\u53d6\u6d88");
        ...
        if (!((Collection)agents2).isEmpty()) {
            DebugHandlerKt.debug((Entity)session.getPlayer(), Debug.CONVERSATION, "\u6267\u884c Agent " + type.name() + ", \u6570\u91cf: " + agents2.size());
        }
    ...
    private static final void open$lambda$7(Session it) {
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
    }

    private static final Boolean checkCondition$lambda$9$lambda$8(Session $session, CompletableFuture $future, Object it) {
        Intrinsics.checkNotNullParameter((Object)$session, (String)"$session");
        Intrinsics.checkNotNullParameter((Object)$future, (String)"$future");
        Object $this$cbool$iv = it;
        boolean $i$f$getCbool = false;
        boolean result = Coerce.toBoolean((Object)$this$cbool$iv);
        DebugHandlerKt.debug((Entity)$session.getPlayer(), Debug.CONVERSATION, "\u6761\u4ef6\u811a\u672c\u6267\u884c\u7ed3\u679c: " + result);
        return $future.complete(result);
    }

    private static final Object agent$process$lambda$12(Session $session, AgentType $type, CompletableFuture $future, int $cur, List $agents, Object it) {
        Object object;
        Intrinsics.checkNotNullParameter((Object)$session, (String)"$session");
        Intrinsics.checkNotNullParameter((Object)((Object)$type), (String)"$type");
        Intrinsics.checkNotNullParameter((Object)$future, (String)"$future");
        ...
        boolean $i$f$getCbool = false;
        if (Coerce.toBoolean((Object)$this$cbool$iv)) {
            DebugHandlerKt.debug((Entity)$session.getPlayer(), Debug.CONVERSATION, "Agent " + $type.name() + " \u88ab\u811a\u672c\u53d6\u6d88");
            object = $future.complete(null);
        } else {
    ...
    private static final Object agent$process$lambda$13(Session $session, AgentType $type, CompletableFuture $future, Throwable it) {
        Intrinsics.checkNotNullParameter((Object)$session, (String)"$session");
        Intrinsics.checkNotNullParameter((Object)((Object)$type), (String)"$type");
        Intrinsics.checkNotNullParameter((Object)$future, (String)"$future");
        DebugHandlerKt.debug((Entity)$session.getPlayer(), Debug.CONVERSATION, "Agent " + $type.name() + " \u5f02\u6b65\u6267\u884c\u5931\u8d25: " + it.getMessage());
        Intrinsics.checkNotNullExpressionValue((Object)it, (String)"it");
        KetherHelperKt.printKetherErrorMessage((Throwable)it, (boolean)true);
        $future.complete(null);
        return null;
    }
    ...
    private static final void agent$process(List<Agent> agents2, AgentType $type, Session $session, CompletableFuture<Void> future, int cur) {
        if (cur < agents2.size()) {
            try {
                ...
                it.add("agent");
                List agent2 = list2;
                ((CompletableFuture)KetherShell.eval$default((KetherShell)KetherShell.INSTANCE, (List)agent2, (boolean)false, $type.namespaceAll(), null, null, null, (Function1)((Function1)new Function1<ScriptContext, Unit>($session, $type){
                    final /* synthetic */ Session $session;
                ...
                }), (int)58, null).thenApply(arg_0 -> Conversation.agent$process$lambda$12($session, $type, future, cur, agents2, arg_0))).exceptionally(arg_0 -> Conversation.agent$process$lambda$13($session, $type, future, arg_0));
            }
            catch (Throwable e) {
                DebugHandlerKt.debug((Entity)$session.getPlayer(), Debug.CONVERSATION, "Agent " + $type.name() + " \u6267\u884c\u5931\u8d25: " + e.getMessage());
                KetherHelperKt.printKetherErrorMessage((Throwable)e, (boolean)true);
                future.complete(null);
            ...
            if (!((Collection)agents2).isEmpty()) {
                DebugHandlerKt.debug((Entity)$session.getPlayer(), Debug.CONVERSATION, "Agent " + $type.name() + " \u6267\u884c\u5b8c\u6210");
            }
            future.complete(null);
        }
    }
