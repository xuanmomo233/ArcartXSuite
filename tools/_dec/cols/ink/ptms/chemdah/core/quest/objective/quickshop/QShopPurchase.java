...
extends ObjectiveCountableI<ShopPurchaseEvent> {
    ...
    @NotNull
    private static final Class<ShopPurchaseEvent> event = ShopPurchaseEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, ShopPurchaseEvent it) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, ShopPurchaseEvent it) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, ShopPurchaseEvent it) {
        return data2.toConditionNumber().check(it.getAmount());
    }

    private static final Boolean _init_$lambda$4(Data data2, ShopPurchaseEvent it) {
        return data2.toConditionNumber().check(it.getTotal());
    }
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", QShopPurchase::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", QShopPurchase::_init_$lambda$2);
        INSTANCE.addSimpleCondition("amount", QShopPurchase::_init_$lambda$3);
        INSTANCE.addSimpleCondition("total", QShopPurchase::_init_$lambda$4);
