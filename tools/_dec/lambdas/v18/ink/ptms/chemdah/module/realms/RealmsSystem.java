    ...
    private final void onJoin(PlayerJoinEvent e) {
        ...
        if (this.getRealms(location) != null) {
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                boolean bl = false;
                if (Intrinsics.areEqual((Object)player.getName(), (Object)e.getPlayer().getName())) continue;
                if (MinecraftVersion.INSTANCE.getMajorLegacy() >= 11300) {
                    player.hidePlayer((Plugin)BukkitPluginKt.getBukkitPlugin(), e.getPlayer());
                    continue;
                }
        ...
        block6: {
            ...
            if (realms2 != null) {
                ...
                for (Object element$iv : $this$forEach$iv) {
                    Player player = (Player)element$iv;
                    boolean bl = false;
                    if (Intrinsics.areEqual((Object)player.getName(), (Object)e.getPlayer().getName()) || !player.canSee(e.getPlayer())) continue;
                    if (MinecraftVersion.INSTANCE.getMajorLegacy() >= 11300) {
                        player.hidePlayer((Plugin)BukkitPluginKt.getBukkitPlugin(), e.getPlayer());
                        continue;
                    }
                ...
                for (Object element$iv : $this$forEach$iv) {
                    ...
                    if (Intrinsics.areEqual((Object)player.getName(), (Object)e.getPlayer().getName()) || player.canSee(e.getPlayer())) continue;
                    if (MinecraftVersion.INSTANCE.getMajorLegacy() >= 11300) {
                        player.showPlayer((Plugin)BukkitPluginKt.getBukkitPlugin(), e.getPlayer());
                        continue;
                    }
