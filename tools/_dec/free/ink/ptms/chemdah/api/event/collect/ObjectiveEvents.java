...
public final class ObjectiveEvents {
    ...
    public static final class Complete {
        ...
        extends BukkitProxyEvent {
            ...
            public Post(@NotNull Objective<?> objective2, @NotNull Task task, @NotNull Quest quest2, @NotNull PlayerProfile playerProfile2) {
        ...
        extends BukkitProxyEvent {
            ...
            public Pre(@NotNull Objective<?> objective2, @NotNull Task task, @NotNull Quest quest2, @NotNull PlayerProfile playerProfile2) {
                Intrinsics.checkNotNullParameter(objective2, (String)"objective");
                Intrinsics.checkNotNullParameter((Object)task, (String)"task");
                Intrinsics.checkNotNullParameter((Object)quest2, (String)"quest");
                Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"playerProfile");
