...
public class Item {
            ...
            public final void invoke(@NotNull ItemMeta $this$modifyMeta) {
                ...
                if (list3 != null) {
                    ...
                    for (T item$iv$iv : $this$mapTo$iv$iv) {
                        ...
                        boolean bl = false;
                        collection.add(item2.format((String)lore, playerProfile, uI, template));
                    }
    ...
    @NotNull
    protected final String format(@Nullable String str, @NotNull PlayerProfile player, @NotNull UI ui2, @NotNull Template template) {
        ...
        return UtilKt.colored((String)KetherFunction.parse$default((KetherFunction)KetherFunction.INSTANCE, (String)string, (boolean)false, UtilsForKetherKt.getNamespaceQuestUI(), null, (ProxyCommandSender)AdapterKt.adaptCommandSender((Object)player.getPlayer()), (KetherShell.VariableMap)new KetherShell.VariableMap(pairArray), null, (int)74, null));
    }
