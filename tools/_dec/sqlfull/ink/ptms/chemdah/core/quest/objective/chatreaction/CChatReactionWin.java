...
extends ObjectiveCountableI<ReactionWinEvent> {
    ...
    @NotNull
    private static final Class<ReactionWinEvent> event = ReactionWinEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, ReactionWinEvent it) {
        InferArea inferArea = data2.toPosition();
        Location location = it.getWinner().getLocation();
        Intrinsics.checkNotNullExpressionValue((Object)location, (String)"it.winner.location");
        return inferArea.inside(location);
    }

    static {
        INSTANCE.handler(CChatReactionWin::_init_$lambda$0);
        INSTANCE.addSimpleCondition("position", CChatReactionWin::_init_$lambda$1);
    }
}
