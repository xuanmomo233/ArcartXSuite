...
public class WizardAction {
    ...
    public WizardAction(@NotNull Player player, @NotNull EntityInstance entityInstance, @NotNull WizardInfo info2) {
    ...
    public final boolean shouldMoving() {
        ...
        if (!(UtilsKt.safeDistance((Location)location, (Location)this.entityInstance.getLocation()) < this.info.getWaitingDistance())) return false;
        return true;
    }
    ...
    public WizardAction check() {
        block7: {
            block6: {
                if (UtilsKt.safeDistance((Location)this.entityInstance.getLocation(), (Location)((Location)CollectionsKt.last(this.info.getNodes()))) < this.info.getFinishDistance()) {
