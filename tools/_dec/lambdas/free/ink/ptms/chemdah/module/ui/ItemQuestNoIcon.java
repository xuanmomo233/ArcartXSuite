            ...
            public final void invoke(@NotNull ItemMeta $this$modifyMeta) {
                block7: {
                    block4: {
                        ...
                        var2_2 = new Pair[]{TuplesKt.to((Object)"name", (Object)this.this$0.format(MetaName.Companion.displayName(this.$template, false, this.$profile), this.$profile, this.$ui, this.$template))};
