...
public interface Mythic {
    ...
    public static /* synthetic */ ItemStack getItemStack$default(Mythic mythic, String string, Player player, int n, Object object) {
        if (object != null) {
        ...
        return mythic.getItemStack(string, player);
    }
