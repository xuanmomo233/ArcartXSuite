...
AXS 共 **17 个主模块**，涵盖聊天、战斗、播报、追踪、登录等核心玩法。
...
<div class="module-grid">
  <a href="announcer" class="module-card">
    ...
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  ...
  <a href="chat" class="module-card">
    ...
    <div class="card-desc">多频道、私聊、@提及、SocialSpy、禁言、跨服 Redis 转发。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  <a href="conversation" class="module-card">
    <div class="card-icon">🗣️</div>
    <div class="card-title">Conversation 对话桥</div>
    <div class="card-desc">Chemdah 对话系统 + Adyeshach NPC 联动，ArcartX UI 渲染。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  <a href="eventpacket" class="module-card">
    <div class="card-icon">⚡</div>
    <div class="card-title">EventPacket 事件引擎</div>
    <div class="card-desc">16 种触发器 × 6 种动作，事件驱动玩法编排</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  ...
  <a href="loginview" class="module-card">
    ...
    <div class="card-desc">ArcartX UI 驱动的登录/注册界面，支持独立模式和 AuthMe 兼容。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  ...
  <a href="onlinerewards" class="module-card">
    ...
    <div class="card-desc">在线时长奖励、每日签到、补签卡、排行榜。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  ...
  <a href="prop" class="module-card">
    ...
    <div class="card-desc">道具快捷键绑定、客户端按键效果、临时属性。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  <a href="rgb" class="module-card">
    <div class="card-icon">🌈</div>
    <div class="card-title">RGB 渐变文本</div>
    <div class="card-desc">PAPI 占位符输出渐变/扫光文本，支持嵌套其他 PAPI。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  <a href="tab" class="module-card">
    <div class="card-icon">📋</div>
    <div class="card-title">Tab 在线列表</div>
    <div class="card-desc">ArcartX TAB UI 驱动的自定义在线列表。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
  <a href="title" class="module-card">
    <div class="card-icon">🏅</div>
    <div class="card-title">Title 称号</div>
    <div class="card-desc">分组称号、有效期/永久、属性加成、PAPI 全量输出。</div>
    <span class="card-badge badge-stable">✅ 稳定</span>
  </a>
</div>
