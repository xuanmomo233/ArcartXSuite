...
extends ObjectiveCountableI<PlayerJumpEvent> {
    ...
    @NotNull
    private static final Class<PlayerJumpEvent> event = PlayerJumpEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerJumpEvent e) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerJump::_init_$lambda$1);
    }
}
