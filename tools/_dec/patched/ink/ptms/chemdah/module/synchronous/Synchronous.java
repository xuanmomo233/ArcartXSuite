...
implements Module {
    ...
    public final void sendSyncLevel(@NotNull Player player2) {
        ...
        PlayerLevel playerLevel = LevelSystem.INSTANCE.getLevel(ChemdahAPI.INSTANCE.getChemdahProfile(player2), option);
        option.getAlgorithm().getExp(playerLevel.getLevel()).thenAccept(arg_0 -> Synchronous.sendSyncLevel$lambda$0((Function1)new Function1<Integer, Unit>(player2, playerLevel){
        ...
        if (Intrinsics.areEqual((Object)e.getOption().getId(), (Object)this.getPlayerLevelToMinecraft())) {
            e.getOption().getAlgorithm().getExp(e.getNewLevel()).thenAccept(arg_0 -> Synchronous.onPlayerEventsLevelChange$lambda$1((Function1)new Function1<Integer, Unit>(e){
                ...
                public final void invoke(Integer exp) {
                    ...
                    MinecraftServerUtilKt.sendPacket((Player)player2, (Object)object);
                }
            }, arg_0));
        }
    }
    ...
    @SubscribeEvent
    private final void onRespawn(PlayerRespawnEvent e) {
        if (this.getPlayerLevelToMinecraft() != null) {
            ExecutorKt.submit$default((boolean)false, (boolean)false, (long)10L, (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(e){
                ...
                public final void invoke(@NotNull PlatformExecutor.PlatformTask $this$submit) {
                    ...
                    Player player2 = this.$e.getPlayer();
                    Intrinsics.checkNotNullExpressionValue((Object)player2, (String)"e.player");
                    Synchronous.INSTANCE.sendSyncLevel(player2);
                }
            }), (int)11, null);
        }
    }
    ...
    @SubscribeEvent
    private final void onRespawn(PlayerChangedWorldEvent e) {
        if (this.getPlayerLevelToMinecraft() != null) {
            ExecutorKt.submit$default((boolean)false, (boolean)false, (long)10L, (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(e){
