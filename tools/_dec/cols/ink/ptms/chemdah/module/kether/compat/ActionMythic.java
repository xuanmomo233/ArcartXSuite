...
public final class ActionMythic {
    ...
    extends ScriptAction<Void> {
        ...
        public CompletableFuture<Void> run(@NotNull QuestContext.Frame frame) {
            ...
            Player player = UtilsForKetherKt.getBukkitPlayer(frame);
            ExecutorKt.submit$default((boolean)false, (boolean)false, (long)0L, (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(this, player){
