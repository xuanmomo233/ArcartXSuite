...
public abstract class Source<T> {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final Source<Object> of(@NotNull Player player) {
            Intrinsics.checkNotNullParameter((Object)player, (String)"player");
            String string = player.getName();
            return new Source<Object>(player, string){
                final /* synthetic */ Player $player;
                {
                    this.$player = $player;
                    Intrinsics.checkNotNullExpressionValue((Object)$super_call_param$1, (String)"name");
                    super($super_call_param$1, $player);
                }
