...
extends ObjectiveCountableI<PlayerRiptideEvent> {
    ...
    @NotNull
    private static final Class<PlayerRiptideEvent> event = PlayerRiptideEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerRiptideEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerRiptideEvent e) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerRiptide::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", IPlayerRiptide::_init_$lambda$2);
    }
}
