...
public class PrimitiveIO {
    ...
    public static void debug(Object message2, Object ... args) {
        if (PrimitiveSettings.IS_DEBUG_MODE) {
            logger.log(Level.INFO, "[DEBUG] " + PrimitiveIO.format(message2, args));
        }
    }

    public static void println(Object message2, Object ... args) {
        logger.log(Level.INFO, PrimitiveIO.format(message2, args));
    }

    public static void warning(Object message2, Object ... args) {
        logger.log(Level.WARNING, PrimitiveIO.format(message2, args));
    }

    public static void error(Object message2, Object ... args) {
        logger.log(Level.SEVERE, PrimitiveIO.format(message2, args));
    }

    private static String format(Object message2, Object ... args) {
        if (args == null || args.length == 0) {
            return Objects.toString(message2);
        }
        return MessageFormat.format(Objects.toString(message2), args);
    }
