...
extends Theme<ThemeChestSetting> {
    ...
    private final CompletableFuture<Integer> rows(Player player, int size) {
            ...
            public final void invoke(Integer rows2) {
                ...
                try {
                    ...
                    $this$invoke_u24lambda_u240.onBuild(true, (Function2)new Function2<Player, Inventory, Unit>(list2, session, list3, bl){
                         ...
                         * WARNING - void declaration
                         */
                        public final void invoke(@NotNull Player player, @NotNull Inventory inventory) {
                            void $this$forEachIndexed$iv;
                            Intrinsics.checkNotNullParameter((Object)player, (String)"<anonymous parameter 0>");
