 ...
 *  cn.mcres.iTeamPro.manager.TeamInfo
 *  cn.mcres.iTeamPro.manager.TeamManager
 ...
 *  com.github.Shawhoi.nyteam.NyTeam
 *  com.github.Shawhoi.nyteam.data.TeamInfo
 *  com.gmail.nossr50.datatypes.party.Party
 *  com.gmail.nossr50.party.PartyManager
 *  com.pxpmc.team.TeamMain
 *  com.pxpmc.team.api.Team
 *  de.HyChrod.Party.Caching.Partydata
 *  de.HyChrod.Party.Caching.Partydata$Member
 *  de.HyChrod.Party.Utilities.PartyAPI
 *  de.erethon.dungeonsxl.DungeonsXL
 *  de.erethon.dungeonsxl.api.player.PlayerGroup
 ...
 *  net.Indyuce.mmocore.party.AbstractParty
 *  net.Indyuce.mmocore.party.provided.Party
 *  org.bukkit.Bukkit
 *  org.bukkit.OfflinePlayer
 *  org.bukkit.entity.Player
 *  org.jetbrains.annotations.NotNull
 *  org.jetbrains.annotations.Nullable
 *  org.serverct.ersha.dungeon.DungeonPlus
 *  org.serverct.ersha.dungeon.common.team.Team
 *  org.serverct.ersha.dungeon.common.team.type.PlayerStateType
 *  sky_bai.bukkit.baiteam.BaiTeam
 *  sky_bai.bukkit.baiteam.team.Team
 *  su.nightexpress.quantumrpg.api.QuantumAPI
 *  su.nightexpress.quantumrpg.modules.list.party.PartyManager
 *  su.nightexpress.quantumrpg.modules.list.party.PartyManager$Party
 *  su.nightexpress.quantumrpg.modules.list.party.PartyManager$PartyMember
 */
...
import ink.ptms.chemdah.module.party.TestPartyManager;
...
public final class PartyHook {
    ...
    implements Party {
        ...
        @Override
        @Nullable
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Object v1;
            block2: {
                ...
                for (Object element$iv : $this$firstOrNull$iv) {
                    ...
                    boolean bl = false;
                    if (!(Intrinsics.areEqual((Object)it.getLeaderName(), (Object)player2.getName()) || it.getMemberNames().contains(player2.getName()))) continue;
                    v1 = element$iv;
                    break block2;
                }
                v1 = null;
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            ...
            block2: {
                ...
                for (Object element$iv : $this$firstOrNull$iv) {
                    ...
                    if (!(((Set)object2).contains(player2.getUniqueId()) || Intrinsics.areEqual((Object)player2.getUniqueId(), (Object)Reflex.Companion.getProperty$default((Reflex.Companion)Reflex.Companion, (Object)it, (String)"leader", (boolean)false, (boolean)false, (boolean)false, null, (int)30, null)))) continue;
                    v2 = element$iv;
                    break block2;
                }
                v2 = null;
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            ...
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            try {
                org.serverct.ersha.dungeon.common.team.Team team = DungeonPlus.INSTANCE.getTeamManager().getTeam(player2);
                if (team == null) {
                    return null;
                }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            PlayerGroup playerGroup = DungeonsXL.getInstance().getPlayerGroup(player2);
            if (playerGroup == null) {
                return null;
            }
            ...
            return new Party.PartyInfo(team){
                ...
                @NotNull
                public Player getLeader() {
                    Player player2 = this.$team.getLeader();
                    Intrinsics.checkNotNullExpressionValue((Object)player2, (String)"team.leader");
                    return player2;
                }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            Partydata partydata = PartyAPI.getParty((UUID)player2.getUniqueId());
            if (partydata == null) {
                return null;
            }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            TeamInfo teamInfo = TeamManager.getTeam((Player)player2);
            if (teamInfo == null) {
                return null;
            }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            ...
            PlayerData playerData = MMOCore.plugin.dataProvider.getDataManager().get((OfflinePlayer)player2);
            if (playerData == null) {
                return null;
            }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            com.gmail.nossr50.datatypes.party.Party party = PartyManager.getParty((Player)player2);
            if (party == null) {
                return null;
            }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            com.github.Shawhoi.nyteam.data.TeamInfo teamInfo = NyTeam.getNyTeamAPI().getPlayerTeam(player2.getName());
            if (teamInfo == null) {
                return null;
            }
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            Object object = Parties.getApi().getPartyPlayer(player2.getUniqueId());
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            PAFPlayer p = PAFPlayerManager.getInstance().getPlayer(player2.getUniqueId());
    ...
    implements Party {
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            Team team = TeamMain.getTeamAPI().getTeam(player2);
            if (team == null) {
                return null;
            }
            Team team2 = team;
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            ...
            block2: {
                ...
                for (Object element$iv : $this$firstOrNull$iv) {
                    ...
                    boolean bl = false;
                    if (!it.isMember(player2)) continue;
                    v2 = element$iv;
                    break block2;
                }
                v2 = null;
    ...
    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u00c6\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016\u00a8\u0006\u0007"}, d2={"Link/ptms/chemdah/module/party/PartyHook$TestPartyHook;", "Link/ptms/chemdah/module/party/Party;", "()V", "getParty", "Link/ptms/chemdah/module/party/Party$PartyInfo;", "player", "Lorg/bukkit/entity/Player;", "Chemdah"})
    public static final class TestPartyHook
    implements Party {
        @NotNull
        public static final TestPartyHook INSTANCE = new TestPartyHook();

        private TestPartyHook() {
        }
        ...
        public Party.PartyInfo getParty(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            TestPartyManager.TestPartyData testPartyData = TestPartyManager.INSTANCE.getPlayerParty(player2);
            if (testPartyData == null) {
                return null;
            }
            TestPartyManager.TestPartyData partyData = testPartyData;
            return new Party.PartyInfo(partyData){
                final /* synthetic */ TestPartyManager.TestPartyData $partyData;
                {
                ...
                @Nullable
                public Player getLeader() {
                    return this.$partyData.getLeader();
                }
