const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.DsfI1kv_.js","assets/chunks/framework.aOZh4hG0.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.DsfI1kv_.js"), true ? __vite__mapDeps([0,1]) : void 0));
