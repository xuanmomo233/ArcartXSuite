...
extends ObjectiveCountableI<PlayerShearEntityEvent> {
    ...
    @NotNull
    private static final Class<PlayerShearEntityEvent> event = PlayerShearEntityEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerShearEntityEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerShearEntityEvent e) {
        return data2.toInferEntity().isEntity(e.getEntity());
    }

    private static final Boolean _init_$lambda$3(Data data2, PlayerShearEntityEvent e) {
    ...
    private static final Boolean _init_$lambda$5(Data data2, PlayerShearEntityEvent e) {
        boolean bl;
        block3: {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerShear::_init_$lambda$1);
        INSTANCE.addSimpleCondition("entity", IPlayerShear::_init_$lambda$2);
        INSTANCE.addSimpleCondition("item", IPlayerShear::_init_$lambda$3);
        INSTANCE.addSimpleCondition("hand", IPlayerShear::_init_$lambda$5);
    }
}
