            ...
            if (string != null) {
                ...
                if (list2 != null) {
                    ...
                    for (Object element$iv : $this$forEach$iv) {
                        ...
                        boolean bl = false;
                        Object[] objectArray = new Object[]{PluginKt.getPluginVersion()};
                        AdapterKt.console().sendMessage("[Chemdah] \u00a7b" + StringKt.replaceWithOrder((String)line, (Object[])objectArray));
                    }
                }
            }
        }
