...
extends BukkitProxyEvent {
    ...
    public PlaceholderHookEvent(@NotNull Player player2, @NotNull PlayerProfile profile, @NotNull String identifier, @NotNull String parameter, @Nullable Object result) {
    ...
    public /* synthetic */ PlaceholderHookEvent(Player player2, PlayerProfile playerProfile2, String string, String string2, Object object, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 0x10) != 0) {
            object = null;
        }
        this(player2, playerProfile2, string, string2, object);
    }
