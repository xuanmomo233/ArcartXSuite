 ...
 *  com.dre.brewery.api.events.barrel.BarrelCreateEvent
 *  kotlin.Metadata
...
@MetaInfo(source="Brewery", name="Brewery \u9152\u6876\u521b\u5efa\u76ee\u6807", description={"\u521b\u5efa Brewery \u9152\u6876", "\u652f\u6301\u4f4d\u7f6e\u6761\u4ef6\u5224\u65ad", "\u9700\u8981 Brewery \u63d2\u4ef6\u652f\u6301"}, alias={"brewery\u9152\u6876\u521b\u5efa", "\u521b\u5efa\u9152\u6876", "\u5236\u4f5c\u9152\u6876"}, params={@ParamInfo(name="position", type="section", description="\u9152\u6876\u521b\u5efa\u4f4d\u7f6e\u6761\u4ef6")})
...
extends ObjectiveCountableI<BarrelCreateEvent> {
    ...
    public Class<BarrelCreateEvent> getEvent() {
        return BarrelCreateEvent.class;
    }
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, BarrelCreateEvent it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
        return it.getBarrel().getSpigot().getLocation();
    }

    static {
        INSTANCE.handler(BBarrelCreate::_init_$lambda$0);
        INSTANCE.addCondition("position", "Location", BBarrelCreate::_init_$lambda$1);
    }
}
