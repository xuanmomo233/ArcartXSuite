...
public class ControlOperator {
    ...
    public static /* synthetic */ void signature$default(ControlOperator controlOperator, PlayerProfile playerProfile2, ControlTrigger controlTrigger, int n, Object object) {
        if (object != null) {
        ...
        controlOperator.signature(playerProfile2, controlTrigger);
    }
