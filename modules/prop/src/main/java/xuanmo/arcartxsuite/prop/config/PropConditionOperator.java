...
public enum PropConditionOperator {
    EQ("=="),
    NE("!="),
    GTE(">="),
    LTE("<="),
    ...
    PropConditionOperator(String symbol) {
        this.symbol = symbol;
    }
    ...
    public static PropConditionOperator parse(String raw) {
        if (raw == null || raw.isBlank()) {
            return EQ;
        }
        String trimmed = raw.trim();
        for (PropConditionOperator operator : values()) {
