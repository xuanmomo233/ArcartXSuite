...
public abstract class QuestContainer {
    ...
    public static /* synthetic */ Quest getQuest$default(QuestContainer questContainer, PlayerProfile playerProfile2, boolean bl, int n, Object object) {
        if (object != null) {
        ...
        return questContainer.getQuest(playerProfile2, bl);
    }
    ...
    public CompletableFuture<Boolean> agent(@NotNull PlayerProfile profile, @NotNull AgentType agentType, @NotNull String restrict, @Nullable String reason) {
        ...
        Intrinsics.checkNotNullParameter((Object)((Object)agentType), (String)"agentType");
        Intrinsics.checkNotNullParameter((Object)restrict, (String)"restrict");
        return this.agent(profile, agentType, restrict, reason, null);
    }

    public static /* synthetic */ CompletableFuture agent$default(QuestContainer questContainer, PlayerProfile playerProfile2, AgentType agentType, String string, String string2, int n, Object object) {
        if (object != null) {
        ...
        return questContainer.agent(playerProfile2, agentType, string, string2);
    }

    @NotNull
    public CompletableFuture<Boolean> agent(@NotNull PlayerProfile profile, @NotNull AgentType agentType, @NotNull String restrict, @Nullable String reason, @Nullable Object event) {
        Intrinsics.checkNotNullParameter((Object)profile, (String)"profile");
        Intrinsics.checkNotNullParameter((Object)((Object)agentType), (String)"agentType");
        Intrinsics.checkNotNullParameter((Object)restrict, (String)"restrict");
        ...
        QuestContainer.agent$process(agent2, profile, agentType, this, future, reason, event, 0);
        return future;
    }
    ...
    private static final Object agent$process$lambda$6(CompletableFuture $future, int $cur, List $agent, PlayerProfile $profile, AgentType $agentType, QuestContainer this$0, String $reason, Object $event, Object it) {
        Boolean bl;
        ...
        if (it instanceof Boolean && !((Boolean)it).booleanValue()) {
            ...
            QuestContainer.agent$process($agent, $profile, $agentType, this$0, $future, $reason, $event, $cur + 1);
            bl = Unit.INSTANCE;
        }
        return bl;
    }

    private static final void agent$process(List<Agent> agent2, PlayerProfile $profile, AgentType $agentType, QuestContainer this$0, CompletableFuture<Boolean> future, String $reason, Object $event, int cur) {
        if (cur < agent2.size()) {
            try {
                ...
                KetherShell.eval$default((KetherShell)ketherShell, list2, (boolean)false, list3, null, (ProxyCommandSender)((ProxyCommandSender)proxyPlayer), null, (Function1)((Function1)new Function1<ScriptContext, Unit>($reason, this$0, $event){
                    ...
                    public final void invoke(@NotNull ScriptContext $this$eval) {
                        ...
                        if (this.$event != null) {
                            $this$eval.set("event", this.$event);
                        }
                    }
                }), (int)42, null).thenApply(arg_0 -> QuestContainer.agent$process$lambda$6(future, cur, agent2, $profile, $agentType, this$0, $reason, $event, arg_0));
            }
            catch (Throwable e) {
