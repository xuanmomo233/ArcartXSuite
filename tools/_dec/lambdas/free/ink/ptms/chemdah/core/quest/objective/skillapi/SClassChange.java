...
@MetaInfo(source="SkillAPI", name="SkillAPI \u804c\u4e1a\u8f6c\u6362\u76ee\u6807", description={"\u73a9\u5bb6\u8f6c\u6362 SkillAPI \u804c\u4e1a", "\u652f\u6301\u4f4d\u7f6e\u3001\u804c\u4e1a\u540d\u79f0\u7b49\u6761\u4ef6\u5224\u65ad", "\u9700\u8981 SkillAPI \u63d2\u4ef6\u652f\u6301"}, alias={"skillapi\u804c\u4e1a\u8f6c\u6362", "\u8f6c\u804c", "\u804c\u4e1a\u53d8\u66f4"}, params={@ParamInfo(name="position", type="Location", description="\u68c0\u67e5\u73a9\u5bb6\u4f4d\u7f6e"), @ParamInfo(name="class", type="String", description="\u8f6c\u6362\u5230\u7684\u804c\u4e1a\u540d\u79f0")})
...
extends ObjectiveCountableI<PlayerClassChangeEvent> {
    ...
    public Class<PlayerClassChangeEvent> getEvent() {
        return PlayerClassChangeEvent.class;
    }
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, PlayerClassChangeEvent it) {
    ...
    private static final Object _init_$lambda$2(PlayerProfile playerProfile2, Task task, PlayerClassChangeEvent it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
    ...
    private static final Object _init_$lambda$3(PlayerClassChangeEvent it) {
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
        return it.getNewClass().getName();
    }
    ...
    static {
        ...
        INSTANCE.addCondition("position", "Location", SClassChange::_init_$lambda$1);
        INSTANCE.addCondition("class", "String", SClassChange::_init_$lambda$2);
        INSTANCE.addConditionVariable("class", SClassChange::_init_$lambda$3);
    }
}
