...
extends ObjectiveCountableI<BlockIgniteEvent> {
    ...
    @NotNull
    private static final Class<BlockIgniteEvent> event = BlockIgniteEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, BlockIgniteEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, BlockIgniteEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, BlockIgniteEvent e) {
        Block block = e.getIgnitingBlock();
        if (block == null) {
            return false;
        }
        return data2.toInferBlock().isBlock(block);
    }

    private static final Boolean _init_$lambda$5(Data data2, BlockIgniteEvent e) {
        boolean bl;
        block3: {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IBlockIgnite::_init_$lambda$1);
        INSTANCE.addSimpleCondition("material", IBlockIgnite::_init_$lambda$2);
        INSTANCE.addSimpleCondition("material:igniting", IBlockIgnite::_init_$lambda$3);
        INSTANCE.addSimpleCondition("cause", IBlockIgnite::_init_$lambda$5);
    }
}
