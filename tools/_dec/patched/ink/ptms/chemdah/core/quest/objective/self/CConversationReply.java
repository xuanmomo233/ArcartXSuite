...
@MetaInfo(source="chemdah", name="\u5bf9\u8bdd\u56de\u590d\u76ee\u6807", description={"\u73a9\u5bb6\u901a\u8fc7\u56de\u590d\u9009\u9879\u7ed3\u675f\u5bf9\u8bdd", "\u652f\u6301\u4f4d\u7f6e\u3001\u5bf9\u8bddID\u7b49\u6761\u4ef6\u5224\u65ad", "\u9002\u7528\u4e8e Chemdah \u5185\u90e8\u5bf9\u8bdd\u7cfb\u7edf"}, alias={"\u5bf9\u8bdd\u56de\u590d", "\u56de\u590d\u5bf9\u8bdd", "conversation\u56de\u590d"}, params={@ParamInfo(name="position", type="location", description="\u68c0\u6d4b\u5bf9\u8bdd\u56de\u590d\u4f4d\u7f6e"), @ParamInfo(name="id", type="string", description="\u5bf9\u8bddID\uff0c\u7528\u4e8e\u8fc7\u6ee4\u7279\u5b9a\u5bf9\u8bdd")})
...
extends ObjectiveCountableI<ConversationEvents.ReplyClosed> {
    ...
    public Class<ConversationEvents.ReplyClosed> getEvent() {
        return ConversationEvents.ReplyClosed.class;
    }
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, ConversationEvents.ReplyClosed it) {
    ...
    private static final Object _init_$lambda$2(PlayerProfile playerProfile2, Task task, ConversationEvents.ReplyClosed it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)((Object)it), (String)"it");
    ...
    private static final Object _init_$lambda$3(ConversationEvents.ReplyClosed it) {
        Intrinsics.checkNotNullParameter((Object)((Object)it), (String)"it");
        return it.getSession().getConversation().getId();
    }
    ...
    static {
        ...
        INSTANCE.addCondition("position", "Location", CConversationReply::_init_$lambda$1);
        INSTANCE.addCondition("id", "String", CConversationReply::_init_$lambda$2);
        INSTANCE.addConditionVariable("id", CConversationReply::_init_$lambda$3);
    }
}
