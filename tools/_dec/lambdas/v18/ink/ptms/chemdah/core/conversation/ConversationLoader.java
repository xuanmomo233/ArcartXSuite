...
public final class ConversationLoader {
    ...
    public final void loadAll() {
        ...
        $this$forEach$iv = new Object[]{LocaleKt.t((String)("\n                \u5df2\u52a0\u8f7d " + ChemdahAPI.INSTANCE.getConversation().size() + " \u9879\u5bf9\u8bdd\u3002\n                " + ChemdahAPI.INSTANCE.getConversation().size() + " conversations loaded.\n            "))};
        IOKt.info((Object[])$this$forEach$iv);
        Iterable $this$groupBy$iv = conversations;
    ...
    public final List<Conversation> load(@NotNull File file) {
        ...
        return SequencesKt.toList((Sequence)SequencesKt.flatMapIterable((Sequence)SequencesKt.filter((Sequence)((Sequence)FilesKt.walk$default((File)file, null, (int)1, null)), (Function1)load.1.INSTANCE), (Function1)((Function1)new Function1<File, List<? extends Conversation>>(file){
             ...
             */
            @NotNull
            public final List<Conversation> invoke(@NotNull File it) {
                ...
                Option option = ChemdahAPI.INSTANCE.getCoreConfigDeserializer().conversationOption(conf.getConfigurationSection(ConversationLoader.INSTANCE.getOptionKey()));
                ...
                for (T element$iv$iv : $this$filterTo$iv$iv) {
                    ...
                    boolean bl = false;
                    if (!(!Intrinsics.areEqual((Object)it2, (Object)ConversationLoader.INSTANCE.getOptionKey()) && conf.isConfigurationSection(it2))) continue;
                ...
                while (iterator.hasNext()) {
                    ...
                    if (new ConversationEvents.Load(file, option, section).call()) {
                        Conversation conversation3;
                        try {
                            conversation3 = ChemdahAPI.INSTANCE.getCoreConfigDeserializer().conversation(file, key, section, option);
                        }
                        catch (Exception e) {
