...
public final class CommandChemdah {
     ...
     */
    public final void commandInfo$Chemdah(@NotNull CommandSender sender, @NotNull Player player2, int page) {
        String partyHook;
        Object object;
        ...
        List<Quest> quests = ChemdahAPI.INSTANCE.getChemdahProfile(player2).getQuests(true);
        ...
        for (Object element$iv$iv : $this$filterTo$iv$iv2) {
            ...
            bl2 = false;
            if (!quest2.isOwner(player2)) continue;
        ...
        for (Object e : $this$filterTo$iv$iv) {
            Quest it2 = (Quest)e;
            bl = false;
            if (!(!it2.isOwner(player2))) continue;
        ...
        if (partyHook != null) {
            ...
            Party.PartyInfo party = PartySystem.INSTANCE.getParty(player2);
            if (party != null) {
                Collection<String> collection2;
                void $this$mapTo$iv$iv3;
                void $this$map$iv3;
                Object item$iv$iv;
                $this$mapTo$iv$iv = new Object[]{party.isLeader(player2)};
                ...
                destination$iv$iv3 = PartySystem.INSTANCE.getPartyMembers(player2, true);
                int n = 0;
                ...
                for (Object item$iv$iv2 : $this$mapTo$iv$iv3) {
                    void it3;
                    Player player3 = (Player)item$iv$iv2;
        ...
        if (ChemdahAPI.INSTANCE.getChemdahProfile(player2).getPersistentDataContainer().isNotEmpty()) {
            show = true;
            showVars = true;
            BukkitLangKt.sendLang((CommandSender)sender, (String)"command-info-data", (Object[])new Object[0]);
            Iterable $this$sortedBy$iv = ChemdahAPI.INSTANCE.getChemdahProfile(player2).getPersistentDataContainer().entries();
        ...
        if (showVars) {
            Set<Map.Entry<String, Data>> vars3 = ChemdahAPI.INSTANCE.getChemdahProfile(player2).getPersistentDataContainer().entries();
            ...
            if (page == 0) {
                if (max2 > 1) {
                    ...
                    objectArray[0] = 1;
                    objectArray[1] = max2;
                    Intrinsics.checkNotNullExpressionValue((Object)player2.getName(), (String)"player.name");
                    objectArray[3] = 2;
    ...
    public static /* synthetic */ void commandInfo$Chemdah$default(CommandChemdah commandChemdah, CommandSender commandSender, Player player2, int n, int n2, Object object) {
        if ((n2 & 4) != 0) {
            n = 0;
        }
        commandChemdah.commandInfo$Chemdah(commandSender, player2, n);
    }
}
