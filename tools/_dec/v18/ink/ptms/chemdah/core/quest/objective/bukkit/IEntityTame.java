...
extends ObjectiveCountableI<EntityTameEvent> {
    ...
    @NotNull
    private static final Class<EntityTameEvent> event = EntityTameEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, EntityTameEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, EntityTameEvent e) {
        return data2.toInferEntity().isEntity((Entity)e.getEntity());
    }

    static {
        INSTANCE.handler(IEntityTame::_init_$lambda$0);
        INSTANCE.addSimpleCondition("position", IEntityTame::_init_$lambda$1);
        INSTANCE.addSimpleCondition("entity", IEntityTame::_init_$lambda$2);
    }
}
