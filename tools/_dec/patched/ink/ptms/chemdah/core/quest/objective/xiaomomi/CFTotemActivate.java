...
@MetaInfo(source="CustomFishing", name="CustomFishing \u56fe\u817e\u6fc0\u6d3b\u76ee\u6807", description={"\u6fc0\u6d3b CustomFishing \u56fe\u817e", "\u652f\u6301\u4f4d\u7f6e\u3001\u56fe\u817e\u7c7b\u578b\u7b49\u6761\u4ef6\u5224\u65ad", "\u9700\u8981 CustomFishing \u63d2\u4ef6\u652f\u6301"}, alias={"customfishing\u56fe\u817e", "\u6fc0\u6d3b\u56fe\u817e", "\u56fe\u817e\u751f\u6548"}, params={@ParamInfo(name="position", type="Location", description="\u56fe\u817e\u6fc0\u6d3b\u7684\u4f4d\u7f6e"), @ParamInfo(name="totem", type="String", description="\u56fe\u817e\u7684 ID")})
...
extends ObjectiveCountableI<TotemActivateEvent> {
    ...
    public Class<TotemActivateEvent> getEvent() {
        return TotemActivateEvent.class;
    }
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, TotemActivateEvent it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
        return it.getCoreLocation();
    }

    private static final Object _init_$lambda$2(PlayerProfile playerProfile2, Task task, TotemActivateEvent it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
        return it.getConfig().id();
    }

    static {
        INSTANCE.handler(CFTotemActivate::_init_$lambda$0);
        INSTANCE.addCondition("position", "Location", CFTotemActivate::_init_$lambda$1);
        INSTANCE.addCondition("totem", "String", CFTotemActivate::_init_$lambda$2);
    }
}
