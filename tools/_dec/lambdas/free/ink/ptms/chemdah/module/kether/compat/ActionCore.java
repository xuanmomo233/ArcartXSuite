...
import ink.ptms.chemdah.module.kether.compat.ActionCore;
...
public final class ActionCore {
    ...
    extends ScriptAction<Object> {
        ...
        public CompletableFuture<Object> run(@NotNull QuestContext.Frame frame) {
            ...
            CompletableFuture<Object> completableFuture = CompletableFuture.completedFuture(this.action.apply(MMOCore.plugin.dataProvider.getDataManager().get((OfflinePlayer)UtilsForKetherKt.getBukkitPlayer(frame))));
            Intrinsics.checkNotNullExpressionValue(completableFuture, (String)"completedFuture(action.a\u2026rame.getBukkitPlayer())))");
            return completableFuture;
        }
    }

    @Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00010\u0004H\u0007\u00a8\u0006\u0005"}, d2={"Link/ptms/chemdah/module/kether/compat/ActionCore$Companion;", "", "()V", "parser", "Link/ptms/chemdah/taboolib/module/kether/ScriptActionParser;", "Chemdah"})
    public static final class Companion {
        private Companion() {
        }

        @KetherParser(value={"mmocore"}, shared=true)
        @NotNull
