...
@SourceDebugExtension(value={"SMAP\nCCratesOpen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CCratesOpen.kt\nink/ptms/chemdah/core/quest/objective/crazycrates/CCratesOpen\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,27:1\n1747#2,3:28\n*S KotlinDebug\n*F\n+ 1 CCratesOpen.kt\nink/ptms/chemdah/core/quest/objective/crazycrates/CCratesOpen\n*L\n21#1:28,3\n*E\n"})
...
extends ObjectiveCountableI<PlayerPrizeEvent> {
    ...
    @NotNull
    private static final Class<PlayerPrizeEvent> event = PlayerPrizeEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerPrizeEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerPrizeEvent e) {
        boolean bl;
        block3: {
            ...
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    ...
                    boolean bl2 = false;
                    if (!StringsKt.equals((String)it, (String)e.getCrate().getName(), (boolean)true)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    private static final Object _init_$lambda$4(PlayerPrizeEvent it) {
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", CCratesOpen::_init_$lambda$1);
        INSTANCE.addSimpleCondition("name", CCratesOpen::_init_$lambda$3);
        INSTANCE.addConditionVariable("name", CCratesOpen::_init_$lambda$4);
    }
}
