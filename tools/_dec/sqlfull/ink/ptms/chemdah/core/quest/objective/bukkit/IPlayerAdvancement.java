...
extends ObjectiveCountableI<PlayerAdvancementDoneEvent> {
    ...
    @NotNull
    private static final Class<PlayerAdvancementDoneEvent> event = PlayerAdvancementDoneEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerAdvancementDoneEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerAdvancementDoneEvent e) {
        boolean bl;
        block3: {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerAdvancement::_init_$lambda$1);
        INSTANCE.addSimpleCondition("advancement", IPlayerAdvancement::_init_$lambda$3);
    }
}
