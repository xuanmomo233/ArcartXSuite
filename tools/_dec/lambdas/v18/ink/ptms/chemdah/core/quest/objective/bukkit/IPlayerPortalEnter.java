...
extends ObjectiveCountableI<EntityPortalEnterEvent> {
    ...
    @NotNull
    private static final Class<EntityPortalEnterEvent> event = EntityPortalEnterEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, EntityPortalEnterEvent e) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerPortalEnter::_init_$lambda$1);
    }
}
