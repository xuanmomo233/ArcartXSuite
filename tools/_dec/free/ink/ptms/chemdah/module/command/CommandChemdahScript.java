...
public final class CommandChemdahScript {
    ...
    public final void sendResult$Chemdah(@NotNull CommandSender $this$sendResult, @Nullable Object v) {
        ...
        try {
            ...
            $this$sendResult.sendMessage(stringBuilder.append(clazz.getClass().getSimpleName()).append(" \u00a77(Java Object)").toString());
        }
        catch (Throwable _) {
            Class<?> clazz;
            $this$sendResult.sendMessage("\u00a7c[System] \u00a77Result: \u00a7f" + v + " \u00a77(" + ((clazz = v) != null && (clazz = clazz.getClass()) != null ? clazz.getSimpleName() : null) + ')');
        }
    }
        ...
        if (script != null) {
            ScriptContext ctx2 = ScriptContext.Companion.create(script, (Function1)new Function1<ScriptContext, Unit>(viewer, args){
                ...
                public final void invoke(@NotNull ScriptContext $this$create) {
                    ...
                    if (this.$viewer != null && (player2 = Bukkit.getPlayerExact((String)this.$viewer)) != null) {
                        $this$create.setSender(AdapterKt.adaptCommandSender((Object)player2));
                    }
