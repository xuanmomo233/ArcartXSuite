...
extends ObjectiveCountableI<CropPlantEvent> {
    ...
    @NotNull
    private static final Class<CropPlantEvent> event = CropPlantEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, CropPlantEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, CropPlantEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, CropPlantEvent e) {
    ...
    private static final Boolean _init_$lambda$4(Data data2, CropPlantEvent e) {
        List<String> list2 = data2.asList();
    ...
    private static final Boolean _init_$lambda$5(Data data2, CropPlantEvent e) {
        List<String> list2 = data2.asList();
    ...
    private static final Boolean _init_$lambda$6(Data data2, CropPlantEvent e) {
        List<String> list2 = data2.asList();
    ...
    private static final Boolean _init_$lambda$7(Data data2, CropPlantEvent e) {
        return data2.toConditionNumber().check(e.point());
    }

    static {
        INSTANCE.handler(CCCropPlantEvent::_init_$lambda$0);
        INSTANCE.addSimpleCondition("position", CCCropPlantEvent::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", CCCropPlantEvent::_init_$lambda$2);
        INSTANCE.addSimpleCondition("crop", CCCropPlantEvent::_init_$lambda$3);
        INSTANCE.addSimpleCondition("crop:seed", CCCropPlantEvent::_init_$lambda$4);
        INSTANCE.addSimpleCondition("block", CCCropPlantEvent::_init_$lambda$5);
        INSTANCE.addSimpleCondition("block:type", CCCropPlantEvent::_init_$lambda$6);
        INSTANCE.addSimpleCondition("point", CCCropPlantEvent::_init_$lambda$7);
    }
}
