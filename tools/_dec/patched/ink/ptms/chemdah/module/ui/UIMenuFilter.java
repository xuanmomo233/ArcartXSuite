...
public final class UIMenuFilter {
    ...
    public final void open(int page) {
        ...
        String string = StringKt.replace(this.ui.getNameFilter(), pairArray);
        ...
        try {
            ...
            $this$open_u24lambda_u240.onGenerate(true, (Function4)new Function4<Player, Include, Integer, Integer, ItemStack>(this){
                ...
                @NotNull
                public final ItemStack invoke(@NotNull Player player2, @NotNull Include include, int n, int n2) {
                    Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
                    Intrinsics.checkNotNullParameter((Object)include, (String)"include");
                    List list2 = this.this$0.getUi().getPlayerFilters().computeIfAbsent(player2.getUniqueId(), arg_0 -> open.1.5.invoke$lambda$0(open.1.includes.1.INSTANCE, arg_0));
                    Intrinsics.checkNotNullExpressionValue((Object)list2, (String)"ui.playerFilters.compute\u2026uniqueId) { ArrayList() }");
                    List includes2 = list2;
