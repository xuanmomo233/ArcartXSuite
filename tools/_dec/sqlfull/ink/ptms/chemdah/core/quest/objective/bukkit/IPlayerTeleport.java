...
extends ObjectiveCountableI<PlayerTeleportEvent> {
    ...
    @NotNull
    private static final Class<PlayerTeleportEvent> event = PlayerTeleportEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerTeleportEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerTeleportEvent e) {
        InferArea inferArea = data2.toPosition();
        Location location = e.getTo();
        if (location == null) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerTeleportEvent e) {
        InferArea inferArea = data2.toPosition();
    ...
    private static final Boolean _init_$lambda$5(Data data2, PlayerTeleportEvent e) {
        boolean bl;
        block3: {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerTeleport::_init_$lambda$1);
        INSTANCE.addSimpleCondition("position:to", IPlayerTeleport::_init_$lambda$2);
        INSTANCE.addSimpleCondition("position:from", IPlayerTeleport::_init_$lambda$3);
        INSTANCE.addSimpleCondition("cause", IPlayerTeleport::_init_$lambda$5);
    }
}
