...
public final class InferEntity {
    ...
    public InferEntity(@NotNull List<? extends Entity> entities2) {
                ...
                if ($this$all$iv instanceof Collection && ((Collection)$this$all$iv).isEmpty()) {
                    ...
                    for (Object element$iv : $this$all$iv) {
                        ...
                        if (Intrinsics.areEqual((Object)string, (Object)"type")) {
                            ...
                            bl2 = DataMatch.ignoreColorCheck$default(it, string2, null, 2, null);
                        } else {
                            Object[] objectArray = new Object[]{this.getName() + '[' + it.getKey() + '=' + it.getPattern() + "] not supported."};
            ...
            block3: {
                ...
                if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                    ...
                    for (Object element$iv : $this$any$iv) {
                        ...
                        boolean bl2 = false;
                        Boolean bl3 = it.getMatch().invoke(type, this.name);
                        Intrinsics.checkNotNullExpressionValue((Object)bl3, (String)"it.match(type, name)");
                ...
                if ($this$all$iv instanceof Collection && ((Collection)$this$all$iv).isEmpty()) {
                    ...
                    for (Object element$iv : $this$all$iv) {
                        ...
                        if (Intrinsics.areEqual((Object)it.getKey(), (Object)"name")) {
                            bl2 = DataMatch.ignoreColorCheck$default(it, NMSTranslateKt.getDisplayName$default((org.bukkit.entity.Entity)entity, null, (int)1, null), null, 2, null);
                        } else {
                            Object[] objectArray = new Object[]{this.name + '[' + it.getKey() + '=' + it.getPattern() + "] not supported."};
                            IOKt.warning((Object[])objectArray);
                            bl2 = false;
                        }
                        if (bl2) continue;
        ...
        public boolean matchData(@NotNull org.bukkit.entity.Entity entity) {
            ...
            block22: {
                ...
                block23: {
                    ...
                    boolean $i$f$all = false;
                    if (!($this$all$iv instanceof Collection) || !((Collection)$this$all$iv).isEmpty()) break block23;
                    bl = true;
                    break block22;
                }
                for (Object element$iv : $this$all$iv) {
                    ...
                    switch (it.getKey()) {
                        ...
                        case "level": {
                            bl2 = new ConditionNumber(it.getPattern().toString()).check(mob.getLevel());
                            break;
                        }
                        case "stance": {
                            bl2 = Intrinsics.areEqual((Object)it.getPattern(), (Object)mob.getStance());
                            break;
                        }
                        case "faction": {
                            bl2 = Intrinsics.areEqual((Object)it.getPattern(), (Object)mob.getFaction());
                            break;
                        }
                        default: {
