...
extends ObjectiveCountableI<ChestOpenEvent> {
    ...
    @NotNull
    private static final Class<ChestOpenEvent> event = ChestOpenEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, ChestOpenEvent it) {
        return data2.toPosition().inside(it.getChestData().getBlock());
    }

    private static final Boolean _init_$lambda$2(Data data2, ChestOpenEvent it) {
        return StringsKt.equals((String)data2.toString(), (String)it.getChestData().getTitle(), (boolean)true);
    }
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", SChestOpen::_init_$lambda$1);
        INSTANCE.addSimpleCondition("title", SChestOpen::_init_$lambda$2);
