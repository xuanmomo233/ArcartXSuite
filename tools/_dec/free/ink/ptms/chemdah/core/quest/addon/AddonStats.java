...
extends Addon {
    ...
    public final String getTitle(@NotNull QuestContainer task, @NotNull Progress progress) {
        ...
        return this.getTitle(task, progress, null);
    }

    @NotNull
    public final String getTitle(@NotNull QuestContainer task, @NotNull Progress progress, @Nullable PlayerProfile profile) {
        Intrinsics.checkNotNullParameter((Object)task, (String)"task");
        Intrinsics.checkNotNullParameter((Object)progress, (String)"progress");
        Pair[] pairArray = new Pair[]{TuplesKt.to((Object)"name", (Object)MetaName.Companion.displayName$default(MetaName.Companion, task, false, profile, 1, null)), TuplesKt.to((Object)"value", (Object)progress.getValue()), TuplesKt.to((Object)"target", (Object)progress.getTarget()), TuplesKt.to((Object)"percent", (Object)Coerce.format((double)(progress.getPercent() * (double)100)))};
    ...
    public static /* synthetic */ CompletableFuture getProgress$default(AddonStats addonStats, PlayerProfile playerProfile2, Task task, int n, Object object) {
        if ((n & 2) != 0) {
            task = null;
        }
        return addonStats.getProgress(playerProfile2, task);
    }
        ...
        public final CompletableFuture<BossBar> statsDisplay(@NotNull QuestContainer $this$statsDisplay, @NotNull PlayerProfile profile) {
            ...
            CompletionStage completionStage = this.getProgress($this$statsDisplay, profile).thenApply(arg_0 -> Companion.statsDisplay$lambda$0((Function1)new Function1<Progress, Boolean>(stats, $this$statsDisplay, profile, future){
                ...
                public final Boolean invoke(Progress progress) {
                    ...
                    bossBar2.setTitle(this.$stats.getTitle(this.$this_statsDisplay, progress, this.$profile));
        ...
        public final void refreshStats(@NotNull QuestContainer $this$refreshStats, @NotNull PlayerProfile profile) {
            ...
            if (stats.getVisibleAlways()) {
                ...
                if (bossBar == null) {
                    ...
                    FuturesKt.applyWithError(this.getProgress($this$refreshStats, profile), (Function1)new Function1<Progress, Unit>(bossBar, stats, $this$refreshStats, profile){
                        ...
                        public final void invoke(@NotNull Progress progress) {
                            ...
                            this.$bossBar.setTitle(this.$stats.getTitle(this.$this_refreshStats, progress, this.$profile));
                        }
                    });
                }
                ...
                if (bossBar == null) {
                    ...
                    FuturesKt.applyWithError(this.getProgress($this$refreshStats, profile), (Function1)new Function1<Progress, Unit>(bossBar, stats, $this$refreshStats, profile){
                        ...
                        public final void invoke(@NotNull Progress progress) {
                            ...
                            this.$bossBar.getKey().setTitle(this.$stats.getTitle(this.$this_refreshStats, progress, this.$profile));
