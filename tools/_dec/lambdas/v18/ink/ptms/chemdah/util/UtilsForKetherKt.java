...
public final class UtilsForKetherKt {
    ...
    public static final Session getSession(@NotNull QuestContext.Frame $this$getSession) {
        ...
        Session session = ChemdahAPI.INSTANCE.getConversationSession(UtilsForKetherKt.getBukkitPlayer($this$getSession));
        if (session == null) {
    ...
    @NotNull
    public static final String parseKether(@NotNull String $this$parseKether, @NotNull Player player) {
        Intrinsics.checkNotNullParameter((Object)$this$parseKether, (String)"<this>");
        Intrinsics.checkNotNullParameter((Object)player, (String)"player");
        return KetherFunction.INSTANCE.parse($this$parseKether, ScriptOptions.Companion.new((Function1)new Function1<ScriptOptions.ScriptOptionsBuilder, Unit>(player){
