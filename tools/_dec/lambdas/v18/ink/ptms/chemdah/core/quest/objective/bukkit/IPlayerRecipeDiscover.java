...
extends ObjectiveCountableI<PlayerRecipeDiscoverEvent> {
    ...
    @NotNull
    private static final Class<PlayerRecipeDiscoverEvent> event = PlayerRecipeDiscoverEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerRecipeDiscoverEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerRecipeDiscoverEvent e) {
        boolean bl;
        block3: {
            ...
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    ...
                    boolean bl2 = false;
                    if (!StringsKt.equals((String)it, (String)e.getRecipe().toString(), (boolean)true)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerRecipeDiscover::_init_$lambda$1);
        INSTANCE.addSimpleCondition("recipe", IPlayerRecipeDiscover::_init_$lambda$3);
    }
}
