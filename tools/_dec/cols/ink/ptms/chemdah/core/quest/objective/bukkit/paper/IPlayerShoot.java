...
extends ObjectiveCountableI<PlayerLaunchProjectileEvent> {
    ...
    @NotNull
    private static final Class<PlayerLaunchProjectileEvent> event = PlayerLaunchProjectileEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerLaunchProjectileEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerLaunchProjectileEvent e) {
        return data2.toInferEntity().isEntity((Entity)e.getProjectile());
    }

    private static final Boolean _init_$lambda$3(Data data2, PlayerLaunchProjectileEvent e) {
    ...
    private static final Boolean _init_$lambda$4(Data data2, PlayerLaunchProjectileEvent e) {
        return data2.toBoolean() == e.shouldConsume();
    }

    static {
        INSTANCE.handler(IPlayerShoot::_init_$lambda$0);
        INSTANCE.addSimpleCondition("position", IPlayerShoot::_init_$lambda$1);
        INSTANCE.addSimpleCondition("projectile", IPlayerShoot::_init_$lambda$2);
        INSTANCE.addSimpleCondition("item", IPlayerShoot::_init_$lambda$3);
        INSTANCE.addSimpleCondition("consume", IPlayerShoot::_init_$lambda$4);
    }
}
