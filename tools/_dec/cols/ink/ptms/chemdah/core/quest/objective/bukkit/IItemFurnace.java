...
extends ObjectiveCountableI<FurnaceExtractEvent> {
    ...
    @NotNull
    private static final Class<FurnaceExtractEvent> event = FurnaceExtractEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, FurnaceExtractEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, FurnaceExtractEvent e) {
        return data2.toInferItem().isItem(new ItemStack(e.getItemType()));
    }

    private static final Boolean _init_$lambda$3(Data data2, FurnaceExtractEvent e) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IItemFurnace::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", IItemFurnace::_init_$lambda$2);
        INSTANCE.addSimpleCondition("exp", IItemFurnace::_init_$lambda$3);
