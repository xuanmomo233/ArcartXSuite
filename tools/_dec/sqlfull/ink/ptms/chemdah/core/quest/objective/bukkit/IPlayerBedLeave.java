...
extends ObjectiveCountableI<PlayerBedLeaveEvent> {
    ...
    @NotNull
    private static final Class<PlayerBedLeaveEvent> event = PlayerBedLeaveEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerBedLeaveEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerBedLeaveEvent e) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerBedLeave::_init_$lambda$1);
        INSTANCE.addSimpleCondition("bed", IPlayerBedLeave::_init_$lambda$2);
    }
}
