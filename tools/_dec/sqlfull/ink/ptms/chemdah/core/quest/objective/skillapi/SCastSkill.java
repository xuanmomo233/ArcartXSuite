...
@SourceDebugExtension(value={"SMAP\nSCastSkill.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SCastSkill.kt\nink/ptms/chemdah/core/quest/objective/skillapi/SCastSkill\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,37:1\n1747#2,3:38\n*S KotlinDebug\n*F\n+ 1 SCastSkill.kt\nink/ptms/chemdah/core/quest/objective/skillapi/SCastSkill\n*L\n28#1:38,3\n*E\n"})
...
extends ObjectiveCountableI<PlayerCastSkillEvent> {
    ...
    @NotNull
    private static final Class<PlayerCastSkillEvent> event = PlayerCastSkillEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerCastSkillEvent it) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerCastSkillEvent e) {
        boolean bl;
        block3: {
            ...
            if ($this$any$iv instanceof Collection && ((Collection)$this$any$iv).isEmpty()) {
                ...
                for (Object element$iv : $this$any$iv) {
                    ...
                    boolean bl2 = false;
                    if (!StringsKt.equals((String)it, (String)e.getSkill().getData().getName(), (boolean)true)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    private static final Boolean _init_$lambda$4(Data data2, PlayerCastSkillEvent it) {
        return data2.toConditionNumber().check(it.getSkill().getManaCost());
    }

    private static final Object _init_$lambda$5(PlayerCastSkillEvent it) {
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", SCastSkill::_init_$lambda$1);
        INSTANCE.addSimpleCondition("skill", SCastSkill::_init_$lambda$3);
        INSTANCE.addSimpleCondition("mana", SCastSkill::_init_$lambda$4);
        INSTANCE.addConditionVariable("mana", SCastSkill::_init_$lambda$5);
    }
}
