...
extends ObjectiveCountableI<PlayerExpChangeEvent> {
    ...
    @NotNull
    private static final Class<PlayerExpChangeEvent> event = PlayerExpChangeEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerExpChangeEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerExpChangeEvent e) {
        return data2.toConditionNumber().check(e.getAmount());
    }

    private static final Boolean _init_$lambda$3(Data data2, PlayerExpChangeEvent e) {
        InferEntity inferEntity = data2.toInferEntity();
        Intrinsics.checkNotNullExpressionValue((Object)e, (String)"e");
        return inferEntity.isEntity((Entity)Reflex.Companion.invokeMethod$default((Reflex.Companion)Reflex.Companion, (Object)e, (String)"getSource", (Object[])new Object[0], (boolean)false, (boolean)false, (boolean)false, null, (int)60, null));
    }
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerExpChange::_init_$lambda$1);
        INSTANCE.addSimpleCondition("amount", IPlayerExpChange::_init_$lambda$2);
        INSTANCE.addSimpleCondition("entity", IPlayerExpChange::_init_$lambda$3);
