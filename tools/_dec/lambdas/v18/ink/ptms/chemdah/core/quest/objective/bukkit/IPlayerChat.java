...
extends ObjectiveCountableI<AsyncPlayerChatEvent> {
    ...
    @NotNull
    private static final Class<AsyncPlayerChatEvent> event = AsyncPlayerChatEvent.class;
    @NotNull
    ...
    private static final Boolean _init_$lambda$1(Data data2, AsyncPlayerChatEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, AsyncPlayerChatEvent e) {
        boolean bl;
        block3: {
    ...
    private static final Object _init_$lambda$4(AsyncPlayerChatEvent it) {
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IPlayerChat::_init_$lambda$1);
        INSTANCE.addSimpleCondition("message", IPlayerChat::_init_$lambda$3);
        INSTANCE.addConditionVariable("message", IPlayerChat::_init_$lambda$4);
    }
}
