...
public final class ActionScenes {
    ...
    public static final class Companion {
                    ...
                    if (!new PlayerEvents.ScenesBlockBreak(e.getPlayer(), (ScenesBlockData)data2).call()) {
                        ExecutorKt.submit$default((boolean)false, (boolean)false, (long)1L, (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(e, vec, (ScenesBlockData)data2){
                            ...
                            public final void invoke(@NotNull PlatformExecutor.PlatformTask $this$submit) {
                                ...
                                ActionScenes.Companion.createScenesBlock(player, BukkitLocationKt.toBukkitLocation((Location)location), this.$data.getMaterial(), this.$data.getData());
                            }
                        }), (int)11, null);
                        e.setCancelled(true);
                    } else {
                        ...
                        Intrinsics.checkNotNullExpressionValue((Object)location, (String)"vec.toLocation(e.player.world.name)");
                        this.removeScenesBlock(player, BukkitLocationKt.toBukkitLocation((Location)location));
                    }
                }
            }
        }
        ...
        private final void onTeleport(PlayerTeleportEvent e) {
            ExecutorKt.submit$default((boolean)false, (boolean)false, (long)20L, (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(e){
                ...
                public final void invoke(@NotNull PlatformExecutor.PlatformTask $this$submit) {
                    ...
                    ActionScenes.Companion.updateScenesBlock(player);
                }
            }), (int)11, null);
        }
        ...
        public static /* synthetic */ void createScenesBlock$default(Companion companion, Player player, org.bukkit.Location location, Material material, byte by, int n, Object object) {
            if ((n & 4) != 0) {
                by = 0;
            }
            companion.createScenesBlock(player, location, material, by);
        }
        ...
        public final void updateScenesBlock(@NotNull Player $this$updateScenesBlock) {
            block2: {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (!(UtilsKt.safeDistance((org.bukkit.Location)loc, (org.bukkit.Location)location2) < 128.0)) continue;
                    if (MinecraftVersion.INSTANCE.getMajorLegacy() >= 11300) {
        ...
        public static /* synthetic */ void createScenesFallingBlock$default(Companion companion, Player player, org.bukkit.Location location, Material material, byte by, boolean bl, int n, Object object) {
            if ((n & 4) != 0) {
                by = 0;
            }
            if ((n & 8) != 0) {
            ...
            companion.createScenesFallingBlock(player, location, material, by, bl);
        }
        ...
        public static /* synthetic */ void removeScenesFallingBlock$default(Companion companion, Player player, org.bukkit.Location location, boolean bl, int n, Object object) {
            if ((n & 2) != 0) {
                bl = false;
            }
            companion.removeScenesFallingBlock(player, location, bl);
        }
            ...
            CompletionStage completionStage = frame.newFrame(this.location).run().thenAccept(arg_0 -> ScenesBlockSet0.run$lambda$0((Function1)new Function1<org.bukkit.Location, Unit>(this, frame){
                ...
                public final void invoke(org.bukkit.Location location) {
                    if (this.this$0.getFalling()) {
                        Player player = UtilsForKetherKt.getBukkitPlayer(this.$frame);
                        Intrinsics.checkNotNullExpressionValue((Object)location, (String)"location");
                        ActionScenes.Companion.createScenesFallingBlock(player, location, this.this$0.getMaterial(), this.this$0.getData(), this.this$0.getSolid());
                    } else {
                        Player player = UtilsForKetherKt.getBukkitPlayer(this.$frame);
                        Intrinsics.checkNotNullExpressionValue((Object)location, (String)"location");
                        ActionScenes.Companion.createScenesBlock(player, location, this.this$0.getMaterial(), this.this$0.getData());
                    }
                }
            }, arg_0));
                    ...
                    this.$frame.newFrame(this.this$0.getCopy()).run().thenAccept(arg_0 -> run.1.invoke$lambda$0((Function1)new Function1<org.bukkit.Location, Unit>(this.this$0, this.$frame, location){
                        ...
                        public final void invoke(org.bukkit.Location copy) {
                            ...
                            if (this.this$0.getFalling()) {
                                ...
                                ActionScenes.Companion.createScenesFallingBlock(player, location, material, block2.getData(), this.this$0.getSolid());
                            } else {
                                Player player = UtilsForKetherKt.getBukkitPlayer(this.$frame);
                                org.bukkit.Location location = this.$location;
                                Intrinsics.checkNotNullExpressionValue((Object)location, (String)"location");
                                Material material = block2.getType();
                                Intrinsics.checkNotNullExpressionValue((Object)material, (String)"block.type");
                                ActionScenes.Companion.createScenesBlock(player, location, material, block2.getData());
                            }
                        }
                    }, arg_0));
                }
