...
@MetaInfo(source="SkillAPI", name="SkillAPI \u7b49\u7ea7\u63d0\u5347\u76ee\u6807", description={"\u73a9\u5bb6 SkillAPI \u7b49\u7ea7\u63d0\u5347", "\u652f\u6301\u4f4d\u7f6e\u3001\u7b49\u7ea7\u6570\u503c\u7b49\u6761\u4ef6\u5224\u65ad", "\u9700\u8981 SkillAPI \u63d2\u4ef6\u652f\u6301"}, alias={"skillapi\u5347\u7ea7", "\u6280\u80fd\u5347\u7ea7", "\u7b49\u7ea7\u63d0\u5347"}, params={@ParamInfo(name="position", type="Location", description="\u68c0\u67e5\u73a9\u5bb6\u4f4d\u7f6e"), @ParamInfo(name="level", type="Number", description="\u73a9\u5bb6\u8fbe\u5230\u7684\u7b49\u7ea7\u6570\u503c")})
...
extends ObjectiveCountableI<PlayerLevelUpEvent> {
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, PlayerLevelUpEvent it) {
    ...
    private static final Object _init_$lambda$2(PlayerProfile playerProfile2, Task task, PlayerLevelUpEvent it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
        return it.getLevel();
    ...
    static {
        ...
        INSTANCE.addCondition("position", "Location", SLevelUp::_init_$lambda$1);
        INSTANCE.addCondition("level", "Number", SLevelUp::_init_$lambda$2);
