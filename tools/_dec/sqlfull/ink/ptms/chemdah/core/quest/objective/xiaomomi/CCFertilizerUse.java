...
extends ObjectiveCountableI<FertilizerUseEvent> {
    ...
    @NotNull
    private static final Class<FertilizerUseEvent> event = FertilizerUseEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, FertilizerUseEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, FertilizerUseEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, FertilizerUseEvent e) {
        List<String> list2 = data2.asList();
        String string = e.fertilizer().id();
        Intrinsics.checkNotNullExpressionValue((Object)string, (String)"e.fertilizer().id()");
        return CollectionKt.has(list2, string);
    }

    private static final Boolean _init_$lambda$4(Data data2, FertilizerUseEvent e) {
        List<String> list2 = data2.asList();
    ...
    private static final Boolean _init_$lambda$5(Data data2, FertilizerUseEvent e) {
        List<String> list2 = data2.asList();
    ...
    private static final Boolean _init_$lambda$6(Data data2, FertilizerUseEvent e) {
        List<String> list2 = data2.asList();
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", CCFertilizerUse::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", CCFertilizerUse::_init_$lambda$2);
        INSTANCE.addSimpleCondition("fertilizer", CCFertilizerUse::_init_$lambda$3);
        INSTANCE.addSimpleCondition("pot", CCFertilizerUse::_init_$lambda$4);
        INSTANCE.addSimpleCondition("block", CCFertilizerUse::_init_$lambda$5);
        INSTANCE.addSimpleCondition("block:type", CCFertilizerUse::_init_$lambda$6);
    }
}
