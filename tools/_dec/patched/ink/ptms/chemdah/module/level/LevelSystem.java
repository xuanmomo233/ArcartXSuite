...
implements Module {
    ...
    public final void setLevel(@NotNull PlayerProfile $this$setLevel, @NotNull LevelOption option, int level, int experience) {
        ...
        Player player2 = $this$setLevel.getPlayer();
        Intrinsics.checkNotNullExpressionValue((Object)player2, (String)"player");
        PlayerEvents.LevelChange event = new PlayerEvents.LevelChange(player2, option, p.getLevel(), p.getExperience(), level, experience);
        if (event.call()) {
