...
extends ObjectiveCountableI<GiftEvent> {
    ...
    @NotNull
    private static final Class<GiftEvent> event = GiftEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, GiftEvent it) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, GiftEvent it) {
        InferItem inferItem = data2.toInferItem();
        ItemStack itemStack = it.getItemStack();
        Intrinsics.checkNotNullExpressionValue((Object)itemStack, (String)"it.itemStack");
        return inferItem.isItem(itemStack);
    }

    static {
        INSTANCE.handler(MMarriageGift::_init_$lambda$0);
        INSTANCE.addSimpleCondition("position", MMarriageGift::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", MMarriageGift::_init_$lambda$2);
    }
}
