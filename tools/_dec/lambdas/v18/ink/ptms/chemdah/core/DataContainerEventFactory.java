    ...
    public static final class Companion {
        ...
        implements DataContainerEventFactory {
            ...
            public Data callPreSet(@NotNull DataContainer container, @NotNull String key, @NotNull Data value2) {
                ...
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                Intrinsics.checkNotNullParameter((Object)value2, (String)"value");
                PlayerEvents.DataSet.Pre event = new PlayerEvents.DataSet.Pre(this.profile.getPlayer(), this.profile, container, key, value2);
            ...
            public void callPostSet(@NotNull DataContainer container, @NotNull String key, @NotNull Data value2) {
                ...
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                Intrinsics.checkNotNullParameter((Object)value2, (String)"value");
                new PlayerEvents.DataSet.Post(this.profile.getPlayer(), this.profile, container, key, value2).call();
            }
            ...
            public boolean callPreRemove(@NotNull DataContainer container, @NotNull String key) {
                Intrinsics.checkNotNullParameter((Object)container, (String)"container");
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                return new PlayerEvents.DataRemove.Pre(this.profile.getPlayer(), this.profile, container, key).call();
            }
            ...
            public void callPostRemove(@NotNull DataContainer container, @NotNull String key) {
                Intrinsics.checkNotNullParameter((Object)container, (String)"container");
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                new PlayerEvents.DataRemove.Post(this.profile.getPlayer(), this.profile, container, key).call();
            }
        }
        ...
        implements DataContainerEventFactory {
            ...
            public Data callPreSet(@NotNull DataContainer container, @NotNull String key, @NotNull Data value2) {
                ...
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                Intrinsics.checkNotNullParameter((Object)value2, (String)"value");
                QuestEvents.DataSet.Pre event = new QuestEvents.DataSet.Pre(this.profile.getPlayer(), this.profile, this.quest, container, key, value2);
                return event.call() ? event.getValue() : null;
            }
            ...
            public void callPostSet(@NotNull DataContainer container, @NotNull String key, @NotNull Data value2) {
                ...
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                Intrinsics.checkNotNullParameter((Object)value2, (String)"value");
                new QuestEvents.DataSet.Post(this.profile.getPlayer(), this.profile, this.quest, container, key, value2).call();
            }
            ...
            public boolean callPreRemove(@NotNull DataContainer container, @NotNull String key) {
                Intrinsics.checkNotNullParameter((Object)container, (String)"container");
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                return new QuestEvents.DataRemove.Pre(this.profile.getPlayer(), this.profile, this.quest, container, key).call();
            }
            ...
            public void callPostRemove(@NotNull DataContainer container, @NotNull String key) {
                Intrinsics.checkNotNullParameter((Object)container, (String)"container");
                Intrinsics.checkNotNullParameter((Object)key, (String)"key");
                new QuestEvents.DataRemove.Post(this.profile.getPlayer(), this.profile, this.quest, container, key).call();
            }
        }
    }
}
