...
public final class ConversationEvents {
    ...
    extends BukkitProxyEvent {
        ...
        public Select(@NotNull Player player, @NotNull String namespace, @NotNull List<String> id2, @Nullable Conversation conversation2, @Nullable Object source) {
    ...
    extends BukkitProxyEvent {
        ...
        public SelectReply(@NotNull Player player, @NotNull Session session, @NotNull PlayerReply reply) {
            Intrinsics.checkNotNullParameter((Object)player, (String)"player");
            Intrinsics.checkNotNullParameter((Object)session, (String)"session");
