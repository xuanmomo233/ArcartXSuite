...
extends ObjectiveCountableI<LandInvitePlayerEvent> {
    ...
    @NotNull
    private static final Class<LandInvitePlayerEvent> event = LandInvitePlayerEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, LandInvitePlayerEvent it) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", LLandsInvite::_init_$lambda$1);
    }
}
