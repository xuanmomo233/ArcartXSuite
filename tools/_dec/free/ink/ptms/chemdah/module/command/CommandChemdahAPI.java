...
public final class CommandChemdahAPI {
    ...
    @CommandBody
    @NotNull
    private static final SimpleCommandBody dump = SimpleCommandKt.subCommand((Function1)dump.1.INSTANCE);
    ...
    @NotNull
    public final SimpleCommandBody getDump() {
        return dump;
    }
