...
public final class TriggerAdyeshachKt {
     ...
     */
    public static final boolean isValidDistance(@NotNull EntityInstance $this$isValidDistance, @NotNull Player player2) {
        ...
        if (!Intrinsics.areEqual((Object)player2.getWorld(), (Object)$this$isValidDistance.getWorld())) return false;
        Location location = player2.getLocation();
        Intrinsics.checkNotNullExpressionValue((Object)location, (String)"player.location");
        if (!(LocationKt.safeDistance(location, $this$isValidDistance.getLocation()) < 10.0)) return false;
        return true;
    }

    @Nullable
    public static final CompletableFuture<Session> openConversation(@NotNull EntityInstance $this$openConversation, @NotNull Player player2, boolean look) {
        ...
        Conversation conversation2 = ConversationManager.INSTANCE.getConversation(player2, "adyeshach", $this$openConversation, stringArray);
        return conversation2 != null ? TriggerAdyeshachKt.openByAdyeshach(conversation2, player2, $this$openConversation, look) : null;
    }

    public static /* synthetic */ CompletableFuture openConversation$default(EntityInstance entityInstance, Player player2, boolean bl, int n, Object object) {
        if ((n & 2) != 0) {
            bl = true;
        }
        return TriggerAdyeshachKt.openConversation(entityInstance, player2, bl);
    }
                ...
                block6: {
                    block5: {
                        ...
                        block4: {
                            ...
                            List<E> entities2 = manager != null ? manager.getEntities() : null;
                            list2 = entities2;
                            ...
                            for (T element$iv$iv : $this$filterTo$iv$iv) {
                                ...
                                boolean bl = false;
                                if (!TriggerAdyeshachKt.isValidDistance(it, player2)) continue;
    ...
    @NotNull
    public static final CompletableFuture<Session> openByAdyeshach(@NotNull Conversation $this$openByAdyeshach, @NotNull Player player2, @NotNull EntityInstance entityInstance, boolean look) {
        ...
        if (look) {
            Vector vector = source.getOriginLocation(source.getEntity()).subtract(player2.getEyeLocation()).toVector().normalize();
            ...
            player2.teleport(temp);
        }
        return Conversation.open$default($this$openByAdyeshach, player2, source, null, arg_0 -> TriggerAdyeshachKt.openByAdyeshach$lambda$0(entityInstance, arg_0), 4, null);
    }

    public static /* synthetic */ CompletableFuture openByAdyeshach$default(Conversation conversation2, Player player2, EntityInstance entityInstance, boolean bl, int n, Object object) {
        if ((n & 4) != 0) {
            bl = true;
        }
        return TriggerAdyeshachKt.openByAdyeshach(conversation2, player2, entityInstance, bl);
    }
    ...
    private static final void openByAdyeshach$lambda$0(EntityInstance $entityInstance, Session it) {
        ...
        it.getVariables().put("id", $entityInstance.getId());
    }
}
