...
@MetaInfo(name="\u73a9\u5bb6\u771f\u5b9e\u79fb\u52a8\u76ee\u6807", description={"\u73a9\u5bb6\u5b9e\u9645\u79fb\u52a8\u65b9\u5757\u65f6\u89e6\u53d1", "\u652f\u6301\u76ee\u6807\u4f4d\u7f6e\u548c\u8d77\u59cb\u4f4d\u7f6e\u7b49\u6761\u4ef6\u5224\u65ad", "\u53ef\u7edf\u8ba1\u79fb\u52a8\u6b21\u6570"}, alias={"\u79fb\u52a8", "\u884c\u8d70", "\u8de8\u65b9\u5757\u79fb\u52a8"}, params={@ParamInfo(name="position", type="Location", description="\u73a9\u5bb6\u5230\u8fbe\u4f4d\u7f6e"), @ParamInfo(name="position:to", type="Location", description="\u73a9\u5bb6\u5230\u8fbe\u4f4d\u7f6e"), @ParamInfo(name="position:from", type="Location", description="\u73a9\u5bb6\u8d77\u59cb\u4f4d\u7f6e")})
@Metadata(mv={1, 8, 0}, k=1, xi=48, d1={"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u00c7\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0003J\u0010\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0014H\u0003R\u001a\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00020\u00058VX\u0096\u0004\u00a2\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0016\u0010\b\u001a\u00070\t\u00a2\u0006\u0002\b\n\u00a2\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0014\u0010\r\u001a\u00020\u000eX\u0096D\u00a2\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010\u00a8\u0006\u0015"}, d2={"Link/ptms/chemdah/core/quest/objective/bukkit/IPlayerRealMove;", "Link/ptms/chemdah/core/quest/objective/ObjectiveCountableI;", "Lorg/bukkit/event/player/PlayerMoveEvent;", "()V", "event", "Ljava/lang/Class;", "getEvent", "()Ljava/lang/Class;", "lock", "Link/ptms/chemdah/taboolib/common5/Baffle;", "Lorg/jetbrains/annotations/NotNull;", "getLock", "()Link/ptms/chemdah/taboolib/common5/Baffle;", "name", "", "getName", "()Ljava/lang/String;", "onQuit", "", "e", "Lorg/bukkit/event/player/PlayerQuitEvent;", "Chemdah"})
public final class IPlayerRealMove
extends ObjectiveCountableI<PlayerMoveEvent> {
    @NotNull
    public static final IPlayerRealMove INSTANCE = new IPlayerRealMove();
    @NotNull
    private static final String name = "player real move";
    @NotNull
    private static final Baffle lock;

    private IPlayerRealMove() {
    }
    ...
    private static final Player _init_$lambda$0(PlayerMoveEvent it) {
        ...
        if (!BukkitEventKt.isBlockMovement((PlayerMoveEvent)it)) return null;
    ...
    static {
        ...
        lock = baffle;
        INSTANCE.handler(IPlayerRealMove::_init_$lambda$0);
        INSTANCE.addCondition("position", "Location", IPlayerRealMove::_init_$lambda$1);
        INSTANCE.addCondition("position:to", "Location", IPlayerRealMove::_init_$lambda$2);
        INSTANCE.addCondition("position:from", "Location", IPlayerRealMove::_init_$lambda$3);
    }
}
