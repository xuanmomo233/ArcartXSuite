...
public interface Party {
    ...
    public static interface PartyInfo {
        default public boolean isLeader(@NotNull Player player) {
            Intrinsics.checkNotNullParameter((Object)player, (String)"player");
            Player player2 = this.getLeader();
            return Intrinsics.areEqual((Object)(player2 != null ? player2.getUniqueId() : null), (Object)player.getUniqueId());
        }
