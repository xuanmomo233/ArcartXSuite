...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"ArcartXSuite","description":"ArcartX 服务器模块化插件 — 17 个主模块，开箱即用","base":"/ArcartXSuite/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","siteTitle":"ArcartXSuite","nav":[{"text":"指南","link":"/guide/","activeMatch":"/guide/"},{"text":"架构","link":"/architecture/","activeMatch":"/architecture/"},{"text":"模块","link":"/modules/","activeMatch":"/modules/"},{"text":"变更日志","link":"/appendix/changelog"},{"text":"链接","items":[{"text":"ArcartX 官方文档","link":"https://wiki.arcartx.com/docs"},{"text":"GitHub","link":"https://github.com/xuanmomo233/ArcartXSuite"}]}],"sidebar":{"/guide/":[{"text":"快速开始","items":[{"text":"概览","link":"/guide/"},{"text":"安装","link":"/guide/installation"},{"text":"模块密码门控","link":"/guide/module-passwords"},{"text":"第一次启用流程","link":"/guide/first-run"},{"text":"命令速查","link":"/guide/commands"},{"text":"PlaceholderAPI 速查","link":"/guide/placeholders"}]}],"/architecture/":[{"text":"架构","items":[{"text":"概览","link":"/architecture/"},{"text":"桥接层 (Bridge)","link":"/architecture/bridges"},{"text":"客户端包守卫","link":"/architecture/security"},{"text":"资源加密 (.axb)","link":"/architecture/protected-resources"},{"text":"数据包流向","link":"/architecture/packet-flow"}]}],"/modules/":[{"text":"模块","items":[{"text":"总览","link":"/modules/"}]},{"text":"主模块","collapsed":false,"items":[{"text":"Announcer 播报系统","link":"/modules/announcer"},{"text":"EntityTracker 实体追踪","link":"/modules/entitytracker"},{"text":"Chat 聊天","link":"/modules/chat"},{"text":"Conversation 对话桥","link":"/modules/conversation"},{"text":"EventPacket 事件引擎","link":"/modules/eventpacket"},{"text":"CombatEffect 战斗特效","link":"/modules/combateffect"},{"text":"LoginView 登录界面","link":"/modules/loginview"},{"text":"Mail 邮箱","link":"/modules/mail"},{"text":"OnlineRewards 在线奖励","link":"/modules/onlinerewards"},{"text":"Pickup 拾取提示","link":"/modules/pickup"},{"text":"Prop 快捷道具","link":"/modules/prop"},{"text":"RGB 渐变文本","link":"/modules/rgb"},{"text":"Tab 在线列表","link":"/modules/tab"},{"text":"Title 称号","link":"/modules/title"}]},{"text":"WIP 模块","collapsed":true,"items":[{"text":"Map 地图","link":"/modules/map"},{"text":"QuestGPS 任务导航","link":"/modules/questgps"},{"text":"Warehouse 仓库","link":"/modules/warehouse"}]}],"/appendix/":[{"text":"附录","items":[{"text":"变更日志","link":"/appendix/changelog"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/xuanmomo233/ArcartXSuite"}],"search":{"provider":"local","options":{"translations":{"button":{"buttonText":"搜索文档","buttonAriaLabel":"搜索文档"},"modal":{"noResultsText":"未找到相关结果","resetButtonTitle":"清除查询","footer":{"selectText":"选择","navigateText":"切换","closeText":"关闭"}}}}},"footer":{"message":"基于 GPL-3.0 许可发布","copyright":"© 2024-2026 墨墨啊"},"outline":{"level":[2,3],"label":"页面导航"},"lastUpdated":{"text":"最后更新"},"docFooter":{"prev":"上一页","next":"下一页"},"returnToTopLabel":"回到顶部","sidebarMenuLabel":"菜单","darkModeSwitchLabel":"主题"},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DNjTNA4A.js"));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "hero-carousel" }, _attrs))} data-v-90bec8d7><p class="carousel-tagline" data-v-90bec8d7><span data-v-90bec8d7>${ssrInterpolate(displayTagline.value)}</span><span class="cursor" data-v-90bec8d7>|</span></p><p class="carousel-sub" data-v-90bec8d7><span data-v-90bec8d7>${ssrInterpolate(displaySub.value)}</span></p></div>`);
    };
  }
});
const _sfc_setup = _sfc_main.setup;
...
const HeroSubtagline = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-90bec8d7"]]);
const RawTheme = {
  extends: theme,
  Layout() {
