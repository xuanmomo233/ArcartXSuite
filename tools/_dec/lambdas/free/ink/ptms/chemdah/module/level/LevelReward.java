...
public final class LevelReward {
    ...
    public final void eval(@NotNull Player player2, int level) {
        Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
        try {
            KetherShell.eval$default((KetherShell)KetherShell.INSTANCE, this.script, (boolean)false, null, null, (ProxyCommandSender)((ProxyCommandSender)AdapterKt.adaptPlayer((Object)player2)), null, (Function1)((Function1)new Function1<ScriptContext, Unit>(level){
