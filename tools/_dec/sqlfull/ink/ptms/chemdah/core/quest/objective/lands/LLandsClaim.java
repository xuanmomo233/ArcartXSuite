...
extends ObjectiveCountableI<ChunkPostClaimEvent> {
    ...
    @NotNull
    private static final Class<ChunkPostClaimEvent> event = ChunkPostClaimEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, ChunkPostClaimEvent it) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", LLandsClaim::_init_$lambda$1);
    }
}
