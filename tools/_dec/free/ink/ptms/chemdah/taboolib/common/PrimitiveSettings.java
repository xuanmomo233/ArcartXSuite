...
public class PrimitiveSettings {
    ...
    public static final String REPO_TABOOLIB = RUNTIME_PROPERTIES.getProperty("repo-taboolib", System.getProperty("ink.ptms.chemdah.taboolib.repo.self", "https://repo.tabooproject.org/repository/releases"));
    public static final String REPO_REFLEX = RUNTIME_PROPERTIES.getProperty("repo-reflex", System.getProperty("ink.ptms.chemdah.taboolib.repo.reflex", "https://repo.tabooproject.org/repository/releases"));
