...
@MetaInfo(source="SkillAPI", name="SkillAPI \u6280\u80fd\u5347\u7ea7\u76ee\u6807", description={"\u73a9\u5bb6\u5347\u7ea7 SkillAPI \u6280\u80fd", "\u652f\u6301\u4f4d\u7f6e\u3001\u6280\u80fd\u540d\u79f0\u7b49\u6761\u4ef6\u5224\u65ad", "\u9700\u8981 SkillAPI \u63d2\u4ef6\u652f\u6301"}, alias={"skillapi\u6280\u80fd\u5347\u7ea7", "\u6280\u80fd\u5f3a\u5316", "\u6280\u80fd\u63d0\u5347"}, params={@ParamInfo(name="position", type="Location", description="\u68c0\u67e5\u73a9\u5bb6\u4f4d\u7f6e"), @ParamInfo(name="skill", type="String", description="\u5347\u7ea7\u7684\u6280\u80fd\u540d\u79f0")})
...
extends ObjectiveCountableI<PlayerSkillUpgradeEvent> {
    ...
    private static final Object _init_$lambda$1(PlayerProfile playerProfile2, Task task, PlayerSkillUpgradeEvent it) {
    ...
    private static final Object _init_$lambda$2(PlayerProfile playerProfile2, Task task, PlayerSkillUpgradeEvent it) {
        Intrinsics.checkNotNullParameter((Object)playerProfile2, (String)"<anonymous parameter 0>");
        Intrinsics.checkNotNullParameter((Object)task, (String)"<anonymous parameter 1>");
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
    ...
    private static final Object _init_$lambda$3(PlayerSkillUpgradeEvent it) {
        Intrinsics.checkNotNullParameter((Object)it, (String)"it");
        return it.getUpgradedSkill().getData().getName();
    }
    ...
    static {
        ...
        INSTANCE.addCondition("position", "Location", SSkillUpgrade::_init_$lambda$1);
        INSTANCE.addCondition("skill", "String", SSkillUpgrade::_init_$lambda$2);
        INSTANCE.addConditionVariable("skill", SSkillUpgrade::_init_$lambda$3);
    }
}
