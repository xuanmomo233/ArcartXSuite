...
extends ObjectiveCountableI<PlayerPickupArrowEvent> {
    ...
    @NotNull
    private static final Class<PlayerPickupArrowEvent> event = PlayerPickupArrowEvent.class;
    ...
    private static final Boolean _init_$lambda$1(Data data2, PlayerPickupArrowEvent e) {
    ...
    private static final Boolean _init_$lambda$2(Data data2, PlayerPickupArrowEvent e) {
    ...
    private static final Boolean _init_$lambda$3(Data data2, PlayerPickupArrowEvent e) {
    ...
    static {
        ...
        INSTANCE.addSimpleCondition("position", IItemPickArrow::_init_$lambda$1);
        INSTANCE.addSimpleCondition("item", IItemPickArrow::_init_$lambda$2);
        INSTANCE.addSimpleCondition("amount", IItemPickArrow::_init_$lambda$3);
