...
set CF_AGENT=
if exist "plugins\ArcartX-Suite\classfinal-agent.jar" (
    set CF_AGENT=-javaagent:plugins\ArcartX-Suite\classfinal-agent.jar="-pwd AXS-CF-KEY"
)
