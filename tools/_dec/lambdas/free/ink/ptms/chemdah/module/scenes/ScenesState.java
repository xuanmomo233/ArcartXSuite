...
public abstract class ScenesState {
    ...
    extends ScenesState {
        ...
        @Override
        public void send(@NotNull Player player2) {
            Object object;
            ...
            try {
                ...
                object = AdapterKt.adaptCommandSender((Object)player2);
            ...
            while (object.hasNext()) {
                ...
                for (Object element$iv2 : $this$forEach$iv2) {
                    ...
                    boolean bl2 = false;
                    if (v.getFalling()) {
                        Location location = pos.toLocation(player2.getWorld().getName());
                        Intrinsics.checkNotNullExpressionValue((Object)location, (String)"pos.toLocation(player.world.name)");
                        ActionScenes.Companion.createScenesFallingBlock$default(ActionScenes.Companion, player2, BukkitLocationKt.toBukkitLocation((Location)location), v.getMaterial(), v.getData(), false, 8, null);
                        continue;
                    }
                    Location location = pos.toLocation(player2.getWorld().getName());
                    Intrinsics.checkNotNullExpressionValue((Object)location, (String)"pos.toLocation(player.world.name)");
                    ActionScenes.Companion.createScenesBlock(player2, BukkitLocationKt.toBukkitLocation((Location)location), v.getMaterial(), v.getData());
                }
            }
            if (this.getAutoNext() > 0) {
                ExecutorKt.submit$default((boolean)false, (boolean)false, (long)this.getAutoNext(), (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(this, player2){
        ...
        @Override
        public void cancel(@NotNull Player player2) {
            Intrinsics.checkNotNullParameter((Object)player2, (String)"player");
            Map<BlockList, ScenesBlockData> $this$forEach$iv = this.set;
            boolean $i$f$forEach = false;
            ...
            while (iterator.hasNext()) {
                ...
                for (Object element$iv2 : $this$forEach$iv2) {
                    ...
                    Location location = pos.toLocation(player2.getWorld().getName());
                    Intrinsics.checkNotNullExpressionValue((Object)location, (String)"pos.toLocation(player.world.name)");
                    ActionScenes.Companion.removeScenesBlock(player2, BukkitLocationKt.toBukkitLocation((Location)location));
                }
            }
            if (this.getAutoNext() > 0) {
                ExecutorKt.submit$default((boolean)false, (boolean)false, (long)this.getAutoNext(), (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(this, player2){
    ...
    extends ScenesState {
        ...
        public void send(@NotNull Player player2) {
            ...
            for (Object item$iv : $this$forEachIndexed$iv) {
                ...
                boolean bl = false;
                if (this.falling) {
                    Location location = blocksTo.get(index).toLocation(player2.getWorld().getName());
                    ...
                    ActionScenes.Companion.createScenesFallingBlock$default(ActionScenes.Companion, player2, location2, material, block.getData(), false, 8, null);
                    continue;
                }
                Location location = blocksTo.get(index).toLocation(player2.getWorld().getName());
                Intrinsics.checkNotNullExpressionValue((Object)location, (String)"blocksTo[index].toLocation(player.world.name)");
                ...
                Material material = block.getType();
                Intrinsics.checkNotNullExpressionValue((Object)material, (String)"block.type");
                ActionScenes.Companion.createScenesBlock(player2, location3, material, block.getData());
            }
            if (this.getAutoNext() > 0) {
                ExecutorKt.submit$default((boolean)false, (boolean)false, (long)this.getAutoNext(), (long)0L, (Function1)((Function1)new Function1<PlatformExecutor.PlatformTask, Unit>(this, player2){
        ...
        public void cancel(@NotNull Player player2) {
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                boolean bl = false;
                if (this.falling) {
                    Location location = it.toLocation(player2.getWorld().getName());
                    Intrinsics.checkNotNullExpressionValue((Object)location, (String)"it.toLocation(player.world.name)");
                    ActionScenes.Companion.removeScenesFallingBlock$default(ActionScenes.Companion, player2, BukkitLocationKt.toBukkitLocation((Location)location), false, 2, null);
                    continue;
                }
                Location location = it.toLocation(player2.getWorld().getName());
                Intrinsics.checkNotNullExpressionValue((Object)location, (String)"it.toLocation(player.world.name)");
